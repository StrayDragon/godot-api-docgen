...
public partial class NavigationObstacle2D : Node2D
{
    ...
    internal NavigationObstacle2D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_224(MethodBind9, GodotObject.GetPtr(this), vertices);
    }
    ...
    {
        return NativeCalls.godot_icall_0_225(MethodBind10, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_208(MethodBind11, GodotObject.GetPtr(this), layers);
    }
    ...
    {
        return NativeCalls.godot_icall_0_209(MethodBind12, GodotObject.GetPtr(this));
    }
