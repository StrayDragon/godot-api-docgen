...
public partial class ProjectSettingsInstance : GodotObject
{
    ...
    internal ProjectSettingsInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    /// <para><b>Note:</b> In order to be be detected, custom settings have to be either defined with <see cref="Godot.ProjectSettingsInstance.SetSetting(string, Variant)"/>, or exist in the <c>project.godot</c> file. This is especially relevant when using <see cref="Godot.ProjectSettingsInstance.SetInitialValue(string, Variant)"/>.</para>
    /// </summary>
    public bool HasSetting(string name)
    {
        return NativeCalls.godot_icall_1_131(MethodBind0, GodotObject.GetPtr(this), name).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_528(MethodBind1, GodotObject.GetPtr(this), name, value);
    }
    ...
    /// <para>See also <see cref="Godot.ProjectSettingsInstance.HasSetting(string)"/> to check whether a setting exists.</para>
    /// </summary>
    public Variant GetSetting(string name, Variant defaultValue = default)
    {
        return NativeCalls.godot_icall_2_1027(MethodBind2, GodotObject.GetPtr(this), name, defaultValue);
    }
    ...
    {
        return NativeCalls.godot_icall_1_143(MethodBind3, GodotObject.GetPtr(this), (godot_string_name)(name?.NativeValue ?? default));
    }
    ...
    {
        return new Godot.Collections.Array<Godot.Collections.Dictionary>(NativeCalls.godot_icall_0_120(MethodBind4, GodotObject.GetPtr(this)));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind5 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSettingWithOverrideAndCustomFeatures, 2434817427ul);

    /// <summary>
    /// <para>Similar to <see cref="Godot.ProjectSettingsInstance.GetSettingWithOverride(StringName)"/>, but applies feature tag overrides instead of current OS features.</para>
    /// </summary>
    public Variant GetSettingWithOverrideAndCustomFeatures(StringName name, string[] features)
    {
        return NativeCalls.godot_icall_2_1028(MethodBind5, GodotObject.GetPtr(this), (godot_string_name)(name?.NativeValue ?? default), features);
    }

    /// <summary>
    /// <para>Similar to <see cref="Godot.ProjectSettingsInstance.GetSettingWithOverride(StringName)"/>, but applies feature tag overrides instead of current OS features.</para>
    /// </summary>
    public Variant GetSettingWithOverrideAndCustomFeatures(StringName name, ReadOnlySpan<string> features)
    {
        return NativeCalls.godot_icall_2_1028(MethodBind5, GodotObject.GetPtr(this), (godot_string_name)(name?.NativeValue ?? default), features);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind6 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetOrder, 2956805083ul);
    ...
    {
        NativeCalls.godot_icall_2_400(MethodBind6, GodotObject.GetPtr(this), name, position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind7 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetOrder, 1321353865ul);
    ...
    {
        return NativeCalls.godot_icall_1_134(MethodBind7, GodotObject.GetPtr(this), name);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind8 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetInitialValue, 402577236ul);
    ...
    {
        NativeCalls.godot_icall_2_528(MethodBind8, GodotObject.GetPtr(this), name, value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind9 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAsBasic, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_497(MethodBind9, GodotObject.GetPtr(this), name, basic.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind10 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAsInternal, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_497(MethodBind10, GodotObject.GetPtr(this), name, @internal.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind11 = ClassDB_get_method_with_compatibility(NativeName, MethodName.AddPropertyInfo, 4155329257ul);
    ...
    /// </code></para>
    /// <para><b>Note:</b> Setting <c>"usage"</c> for the property is not supported. Use <see cref="Godot.ProjectSettingsInstance.SetAsBasic(string, bool)"/>, <see cref="Godot.ProjectSettingsInstance.SetRestartIfChanged(string, bool)"/>, and <see cref="Godot.ProjectSettingsInstance.SetAsInternal(string, bool)"/> to modify usage flags.</para>
    /// </summary>
    public void AddPropertyInfo(Godot.Collections.Dictionary hint)
    {
        NativeCalls.godot_icall_1_121(MethodBind11, GodotObject.GetPtr(this), (godot_dictionary)(hint ?? new()).NativeValue);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetRestartIfChanged, 2678287736ul);
    ...
    {
        NativeCalls.godot_icall_2_497(MethodBind12, GodotObject.GetPtr(this), name, restart.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Clear, 83702148ul);
    ...
    {
        NativeCalls.godot_icall_1_57(MethodBind13, GodotObject.GetPtr(this), name);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = ClassDB_get_method_with_compatibility(NativeName, MethodName.LocalizePath, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind14, GodotObject.GetPtr(this), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind15 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GlobalizePath, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind15, GodotObject.GetPtr(this), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind16 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Save, 166280745ul);
    ...
    public Error Save()
    {
        return (Error)NativeCalls.godot_icall_0_39(MethodBind16, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind17 = ClassDB_get_method_with_compatibility(NativeName, MethodName.LoadResourcePack, 708980503ul);
    ...
    {
        return NativeCalls.godot_icall_3_1029(MethodBind17, GodotObject.GetPtr(this), pack, replaceFiles.ToGodotBool(), offset).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind18 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SaveCustom, 166001499ul);
    ...
    {
        return (Error)NativeCalls.godot_icall_1_134(MethodBind18, GodotObject.GetPtr(this), file);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind19 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetChangedSettings, 1139954409ul);

    /// <summary>
    /// <para>Gets an array of the settings which have been changed since the last save. Note that internally <c>changed_settings</c> is cleared after a successful save, so generally the most appropriate place to use this method is when processing <see cref="Godot.ProjectSettingsInstance.SettingsChanged"/>.</para>
    /// </summary>
    public string[] GetChangedSettings()
    {
        return NativeCalls.godot_icall_0_108(MethodBind19, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind20 = ClassDB_get_method_with_compatibility(NativeName, MethodName.CheckChangedSettingsInGroup, 3927539163ul);

    /// <summary>
    /// <para>Checks if any settings with the prefix <paramref name="settingPrefix"/> exist in the set of changed settings. See also <see cref="Godot.ProjectSettingsInstance.GetChangedSettings()"/>.</para>
    /// </summary>
    public bool CheckChangedSettingsInGroup(string settingPrefix)
    {
        return NativeCalls.godot_icall_1_131(MethodBind20, GodotObject.GetPtr(this), settingPrefix).ToBool();
    }
