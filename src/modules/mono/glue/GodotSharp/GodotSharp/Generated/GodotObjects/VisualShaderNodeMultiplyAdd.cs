...
public partial class VisualShaderNodeMultiplyAdd : VisualShaderNode
{
    ...
    internal VisualShaderNodeMultiplyAdd(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeMultiplyAdd.OpTypeEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
