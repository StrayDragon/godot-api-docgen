...
public partial class VisualShaderNodeTransformFunc : VisualShaderNode
{
    ...
    /// <summary>
    /// <para>The function to be computed.</para>
    /// </summary>
    ...
    internal VisualShaderNodeTransformFunc(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeTransformFunc.FunctionEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
