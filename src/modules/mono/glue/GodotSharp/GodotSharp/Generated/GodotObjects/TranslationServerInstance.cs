...
public partial class TranslationServerInstance : GodotObject
{
    ...
    internal TranslationServerInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return NativeCalls.godot_icall_2_330(MethodBind3, GodotObject.GetPtr(this), localeA, localeB);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind4 = ClassDB_get_method_with_compatibility(NativeName, MethodName.StandardizeLocale, 4216441673ul);
    ...
    {
        return NativeCalls.godot_icall_2_1470(MethodBind4, GodotObject.GetPtr(this), locale, addDefaults.ToGodotBool());
    }
    ...
    {
        return NativeCalls.godot_icall_0_108(MethodBind5, GodotObject.GetPtr(this));
    }
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind6, GodotObject.GetPtr(this), language);
    }
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind8, GodotObject.GetPtr(this), script);
    }
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind10, GodotObject.GetPtr(this), country);
    }
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind11, GodotObject.GetPtr(this), locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPluralRules, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind12, GodotObject.GetPtr(this), locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Translate, 1829228469ul);
    ...
    {
        return NativeCalls.godot_icall_2_292(MethodBind13, GodotObject.GetPtr(this), (godot_string_name)(message?.NativeValue ?? default), (godot_string_name)(context?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = ClassDB_get_method_with_compatibility(NativeName, MethodName.TranslatePlural, 229954002ul);
    ...
    {
        return NativeCalls.godot_icall_4_1467(MethodBind14, GodotObject.GetPtr(this), (godot_string_name)(message?.NativeValue ?? default), (godot_string_name)(pluralMessage?.NativeValue ?? default), n, (godot_string_name)(context?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind15 = ClassDB_get_method_with_compatibility(NativeName, MethodName.AddTranslation, 1466479800ul);
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind15, GodotObject.GetPtr(this), GodotObject.GetPtr(translation));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind16 = ClassDB_get_method_with_compatibility(NativeName, MethodName.RemoveTranslation, 1466479800ul);
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind16, GodotObject.GetPtr(this), GodotObject.GetPtr(translation));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind17 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetTranslationObject, 2065240175ul);
    ...
    /// </summary>
    [Obsolete("Use 'Godot.TranslationServerInstance.FindTranslations(string, bool)' instead.")]
    public Translation GetTranslationObject(string locale)
    {
        return (Translation)NativeCalls.godot_icall_1_533(MethodBind17, GodotObject.GetPtr(this), locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind18 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetTranslations, 3995934104ul);

    /// <summary>
    /// <para>Returns all available <see cref="Godot.Translation"/> instances in the main translation domain as added by <see cref="Godot.TranslationServerInstance.AddTranslation(Translation)"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Translation> GetTranslations()
    {
        return new Godot.Collections.Array<Translation>(NativeCalls.godot_icall_0_120(MethodBind18, GodotObject.GetPtr(this)));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind19 = ClassDB_get_method_with_compatibility(NativeName, MethodName.FindTranslations, 2109650934ul);

    /// <summary>
    /// <para>Returns the <see cref="Godot.Translation"/> instances in the main translation domain that match <paramref name="locale"/> (see <see cref="Godot.TranslationServerInstance.CompareLocales(string, string)"/>). If <paramref name="exact"/> is <see langword="true"/>, only instances whose locale exactly equals <paramref name="locale"/> will be returned.</para>
    /// </summary>
    public Godot.Collections.Array<Translation> FindTranslations(string locale, bool exact)
    {
        return new Godot.Collections.Array<Translation>(NativeCalls.godot_icall_2_1469(MethodBind19, GodotObject.GetPtr(this), locale, exact.ToGodotBool()));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind20 = ClassDB_get_method_with_compatibility(NativeName, MethodName.HasTranslationForLocale, 2034713381ul);

    /// <summary>
    /// <para>Returns <see langword="true"/> if there are any <see cref="Godot.Translation"/> instances in the main translation domain that match <paramref name="locale"/> (see <see cref="Godot.TranslationServerInstance.CompareLocales(string, string)"/>). If <paramref name="exact"/> is <see langword="true"/>, only instances whose locale exactly equals <paramref name="locale"/> are considered.</para>
    /// </summary>
    public bool HasTranslationForLocale(string locale, bool exact)
    {
        return NativeCalls.godot_icall_2_1468(MethodBind20, GodotObject.GetPtr(this), locale, exact.ToGodotBool()).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind21 = ClassDB_get_method_with_compatibility(NativeName, MethodName.HasTranslation, 2696976312ul);
    ...
    {
        return NativeCalls.godot_icall_1_176(MethodBind21, GodotObject.GetPtr(this), GodotObject.GetPtr(translation)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind22 = ClassDB_get_method_with_compatibility(NativeName, MethodName.HasDomain, 2619796661ul);
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind22, GodotObject.GetPtr(this), (godot_string_name)(domain?.NativeValue ?? default)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind23 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetOrAddDomain, 397200075ul);
    ...
    {
        return (TranslationDomain)NativeCalls.godot_icall_1_119(MethodBind23, GodotObject.GetPtr(this), (godot_string_name)(domain?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind24 = ClassDB_get_method_with_compatibility(NativeName, MethodName.RemoveDomain, 3304788590ul);
    ...
    {
        NativeCalls.godot_icall_1_64(MethodBind24, GodotObject.GetPtr(this), (godot_string_name)(domain?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind25 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Clear, 3218959716ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind26 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetLoadedLocales, 1139954409ul);
    ...
    {
        return NativeCalls.godot_icall_0_108(MethodBind26, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind27 = ClassDB_get_method_with_compatibility(NativeName, MethodName.FormatNumber, 315676799ul);
    ...
    {
        return NativeCalls.godot_icall_2_1398(MethodBind27, GodotObject.GetPtr(this), number, locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind28 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPercentSign, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind28, GodotObject.GetPtr(this), locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind29 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ParseNumber, 315676799ul);
    ...
    {
        return NativeCalls.godot_icall_2_1398(MethodBind29, GodotObject.GetPtr(this), number, locale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind30 = ClassDB_get_method_with_compatibility(NativeName, MethodName.IsPseudolocalizationEnabled, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind31 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPseudolocalizationEnabled, 2586408642ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPseudolocalizationEnabled(bool enabled)
    {
        NativeCalls.godot_icall_1_14(MethodBind31, GodotObject.GetPtr(this), enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind32 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ReloadPseudolocalization, 3218959716ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind33 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Pseudolocalize, 1965194235ul);
    ...
    {
        return NativeCalls.godot_icall_1_164(MethodBind33, GodotObject.GetPtr(this), (godot_string_name)(message?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind34 = ClassDB_get_method_with_compatibility(NativeName, MethodName.StandardizeLocale, 3135753539ul);
    ...
    {
        return NativeCalls.godot_icall_1_304(MethodBind34, GodotObject.GetPtr(this), locale);
    }
