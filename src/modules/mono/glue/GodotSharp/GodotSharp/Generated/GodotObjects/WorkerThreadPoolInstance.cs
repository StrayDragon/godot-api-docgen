...
public partial class WorkerThreadPoolInstance : GodotObject
{
    ...
    internal WorkerThreadPoolInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return NativeCalls.godot_icall_3_1506(MethodBind0, GodotObject.GetPtr(this), action, highPriority.ToGodotBool(), description);
    }
    ...
    {
        return (Error)NativeCalls.godot_icall_1_562(MethodBind2, GodotObject.GetPtr(this), taskId);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCallerTaskId, 3905245786ul);
    ...
    {
        return NativeCalls.godot_icall_0_4(MethodBind3, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind4 = ClassDB_get_method_with_compatibility(NativeName, MethodName.AddGroupTask, 1801953219ul);
    ...
    {
        return NativeCalls.godot_icall_5_1507(MethodBind4, GodotObject.GetPtr(this), action, elements, tasksNeeded, highPriority.ToGodotBool(), description);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind5 = ClassDB_get_method_with_compatibility(NativeName, MethodName.IsGroupTaskCompleted, 1116898809ul);
    ...
    {
        return NativeCalls.godot_icall_1_11(MethodBind5, GodotObject.GetPtr(this), groupId).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind6 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetGroupProcessedElementCount, 923996154ul);
    ...
    {
        return NativeCalls.godot_icall_1_948(MethodBind6, GodotObject.GetPtr(this), groupId);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind7 = ClassDB_get_method_with_compatibility(NativeName, MethodName.WaitForGroupTaskCompletion, 1286410249ul);
    ...
    {
        NativeCalls.godot_icall_1_10(MethodBind7, GodotObject.GetPtr(this), groupId);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind8 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCallerGroupId, 3905245786ul);
