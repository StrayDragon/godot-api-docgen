...
public partial class NavigationPathQueryParameters2D : RefCounted
{
    ...
    /// <summary>
    /// <para>The list of region <see cref="Godot.Rid"/>s that will be excluded from the path query. Use <see cref="Godot.NavigationRegion2D.GetRid()"/> to get the <see cref="Godot.Rid"/> associated with a <see cref="Godot.NavigationRegion2D"/> node.</para>
    ...
    /// <summary>
    /// <para>The list of region <see cref="Godot.Rid"/>s that will be included by the path query. Use <see cref="Godot.NavigationRegion2D.GetRid()"/> to get the <see cref="Godot.Rid"/> associated with a <see cref="Godot.NavigationRegion2D"/> node. If left empty all regions are included. If a region ends up being both included and excluded at the same time it will be excluded.</para>
    /// <para><b>Note:</b> The returned array is copied and any changes to it will not update the original property value. To update the value you need to modify the returned array, and then set it to the property again.</para>
    /// </summary>
    ...
    /// <para><b>Note:</b> This will perform a circle shaped clip operation on the path with the first path position being the circle's center position.</para>
    /// </summary>
    ...
    internal NavigationPathQueryParameters2D(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (NavigationPathQueryParameters2D.PathfindingAlgorithmEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
    ...
    {
        return (NavigationPathQueryParameters2D.PathPostProcessing)NativeCalls.godot_icall_0_39(MethodBind3, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind6, GodotObject.GetPtr(this), &startPosition);
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind8, GodotObject.GetPtr(this), &targetPosition);
    }
    ...
    {
        return (NavigationPathQueryParameters2D.PathMetadataFlags)NativeCalls.godot_icall_0_39(MethodBind13, GodotObject.GetPtr(this));
    }
