...
/// <para><b>Note:</b> Several methods of this class, such as <see cref="Godot.NavigationAgent2D.GetNextPathPosition()"/>, can trigger a new path calculation. Calling these in your callback to an agent's signal, such as <see cref="Godot.NavigationAgent2D.WaypointReached"/>, can cause infinite recursion. It is recommended to call these methods in the physics step or, alternatively, delay their call until the end of the frame (see <see cref="Godot.GodotObject.CallDeferred(StringName, Variant[])"/> or <see cref="Godot.GodotObject.ConnectFlags.Deferred"/>).</para>
/// </summary>
public partial class NavigationAgent2D : Node
{
    ...
    /// <summary>
    /// <para>The maximum allowed length of the returned path in world units. A path will be clipped when going over this length.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>The maximum allowed radius in world units that the returned path can be from the path start. The path will be clipped when going over this radius. Compared to <see cref="Godot.NavigationAgent2D.PathReturnMaxLength"/>, this allows the agent to go that much further, if they need to walk around a corner.</para>
    /// <para><b>Note:</b> This will perform a sphere clip considering only the actual navigation mesh path points with the first path position being the sphere's center.</para>
    /// </summary>
    ...
    /// <para>Does not affect normal pathfinding. To change an actor's pathfinding radius bake <see cref="Godot.NavigationPolygon"/> resources with a different <see cref="Godot.NavigationPolygon.AgentRadius"/> property and use different navigation maps for each actor size.</para>
    /// </summary>
    public float Radius
    {
        get
    ...
    internal NavigationAgent2D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind3, GodotObject.GetPtr(this), desiredDistance);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind5, GodotObject.GetPtr(this), desiredDistance);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind7, GodotObject.GetPtr(this), radius);
    }
    ...
    {
        return NativeCalls.godot_icall_0_68(MethodBind8, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind9, GodotObject.GetPtr(this), neighborDistance);
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind11, GodotObject.GetPtr(this), maxNeighbors);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind13, GodotObject.GetPtr(this), timeHorizon);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind15, GodotObject.GetPtr(this), timeHorizon);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind17, GodotObject.GetPtr(this), maxSpeed);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind19, GodotObject.GetPtr(this), maxSpeed);
    }
    ...
    {
        NativeCalls.godot_icall_1_208(MethodBind21, GodotObject.GetPtr(this), navigationLayers);
    }
    ...
    {
        return NativeCalls.godot_icall_0_209(MethodBind22, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_2_61(MethodBind23, GodotObject.GetPtr(this), layerNumber, value.ToGodotBool());
    }
    ...
    {
        return NativeCalls.godot_icall_1_62(MethodBind24, GodotObject.GetPtr(this), layerNumber).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind25, GodotObject.GetPtr(this), (int)pathfindingAlgorithm);
    }
    ...
    {
        return (NavigationPathQueryParameters2D.PathfindingAlgorithmEnum)NativeCalls.godot_icall_0_39(MethodBind26, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind27, GodotObject.GetPtr(this), (int)pathPostprocessing);
    }
    ...
    {
        return (NavigationPathQueryParameters2D.PathPostProcessing)NativeCalls.godot_icall_0_39(MethodBind28, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind29, GodotObject.GetPtr(this), (int)flags);
    }
    ...
    {
        return (NavigationPathQueryParameters2D.PathMetadataFlags)NativeCalls.godot_icall_0_39(MethodBind30, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_286(MethodBind31, GodotObject.GetPtr(this), navigationMap);
    }
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind32, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind33, GodotObject.GetPtr(this), &position);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind37, GodotObject.GetPtr(this), epsilon);
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind39 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPathReturnMaxLength, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPathReturnMaxLength(float length)
    {
        NativeCalls.godot_icall_1_67(MethodBind39, GodotObject.GetPtr(this), length);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind40 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPathReturnMaxLength, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind41 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPathReturnMaxRadius, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPathReturnMaxRadius(float radius)
    {
        NativeCalls.godot_icall_1_67(MethodBind41, GodotObject.GetPtr(this), radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind42 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPathReturnMaxRadius, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind43 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPathSearchMaxPolygons, 1286410249ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPathSearchMaxPolygons(int maxPolygons)
    {
        NativeCalls.godot_icall_1_38(MethodBind43, GodotObject.GetPtr(this), maxPolygons);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind44 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPathSearchMaxPolygons, 3905245786ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public int GetPathSearchMaxPolygons()
    {
        return NativeCalls.godot_icall_0_39(MethodBind44, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind45 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetPathSearchMaxDistance, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetPathSearchMaxDistance(float distance)
    {
        NativeCalls.godot_icall_1_67(MethodBind45, GodotObject.GetPtr(this), distance);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind46 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPathSearchMaxDistance, 1740695150ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public float GetPathSearchMaxDistance()
    {
        return NativeCalls.godot_icall_0_68(MethodBind46, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind47 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetPathLength, 1740695150ul);

    /// <summary>
    /// <para>Returns the length of the currently calculated path. The returned value is <c>0.0</c>, if the path is still calculating or no calculation has been requested yet.</para>
    /// </summary>
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind48 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetNextPathPosition, 1497962370ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind49 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetVelocityForced, 743155724ul);
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind49, GodotObject.GetPtr(this), &velocity);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind50 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetVelocity, 743155724ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetVelocity(Vector2 velocity)
    {
        NativeCalls.godot_icall_1_36(MethodBind50, GodotObject.GetPtr(this), &velocity);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind51 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetVelocity, 1497962370ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind52 = ClassDB_get_method_with_compatibility(NativeName, MethodName.DistanceToTarget, 1740695150ul);
    ...
    {
        return NativeCalls.godot_icall_0_68(MethodBind52, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind53 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCurrentNavigationResult, 166799483ul);
    ...
    {
        return (NavigationPathQueryResult2D)NativeCalls.godot_icall_0_63(MethodBind53, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind54 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCurrentNavigationPath, 2961356807ul);
    ...
    {
        return NativeCalls.godot_icall_0_225(MethodBind54, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind55 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCurrentNavigationPathIndex, 3905245786ul);
    ...
    {
        return NativeCalls.godot_icall_0_39(MethodBind55, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind56 = ClassDB_get_method_with_compatibility(NativeName, MethodName.IsTargetReached, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind57 = ClassDB_get_method_with_compatibility(NativeName, MethodName.IsTargetReachable, 2240911060ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind58 = ClassDB_get_method_with_compatibility(NativeName, MethodName.IsNavigationFinished, 2240911060ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind59 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetFinalPosition, 1497962370ul);
    ...
    {
        return NativeCalls.godot_icall_0_37(MethodBind59, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind60 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAvoidanceLayers, 1286410249ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetAvoidanceLayers(uint layers)
    {
        NativeCalls.godot_icall_1_208(MethodBind60, GodotObject.GetPtr(this), layers);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind61 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetAvoidanceLayers, 3905245786ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public uint GetAvoidanceLayers()
    {
        return NativeCalls.godot_icall_0_209(MethodBind61, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind62 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAvoidanceMask, 1286410249ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetAvoidanceMask(uint mask)
    {
        NativeCalls.godot_icall_1_208(MethodBind62, GodotObject.GetPtr(this), mask);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind63 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetAvoidanceMask, 3905245786ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public uint GetAvoidanceMask()
    {
        return NativeCalls.godot_icall_0_209(MethodBind63, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind64 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAvoidanceLayerValue, 300928843ul);
    ...
    {
        NativeCalls.godot_icall_2_61(MethodBind64, GodotObject.GetPtr(this), layerNumber, value.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind65 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetAvoidanceLayerValue, 1116898809ul);
    ...
    {
        return NativeCalls.godot_icall_1_62(MethodBind65, GodotObject.GetPtr(this), layerNumber).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind66 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAvoidanceMaskValue, 300928843ul);
    ...
    {
        NativeCalls.godot_icall_2_61(MethodBind66, GodotObject.GetPtr(this), maskNumber, value.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind67 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetAvoidanceMaskValue, 1116898809ul);
    ...
    {
        return NativeCalls.godot_icall_1_62(MethodBind67, GodotObject.GetPtr(this), maskNumber).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind68 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetAvoidancePriority, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetAvoidancePriority(float priority)
    {
        NativeCalls.godot_icall_1_67(MethodBind68, GodotObject.GetPtr(this), priority);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind69 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetAvoidancePriority, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind70 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugEnabled, 2586408642ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind71 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugEnabled, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind72 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugUseCustom, 2586408642ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetDebugUseCustom(bool enabled)
    {
        NativeCalls.godot_icall_1_14(MethodBind72, GodotObject.GetPtr(this), enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind73 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugUseCustom, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind74 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugPathCustomColor, 2920490490ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetDebugPathCustomColor(Color color)
    {
        NativeCalls.godot_icall_1_213(MethodBind74, GodotObject.GetPtr(this), &color);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind75 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugPathCustomColor, 3444240500ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Color GetDebugPathCustomColor()
    {
        return NativeCalls.godot_icall_0_214(MethodBind75, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind76 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugPathCustomPointSize, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetDebugPathCustomPointSize(float pointSize)
    {
        NativeCalls.godot_icall_1_67(MethodBind76, GodotObject.GetPtr(this), pointSize);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind77 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugPathCustomPointSize, 1740695150ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public float GetDebugPathCustomPointSize()
    {
        return NativeCalls.godot_icall_0_68(MethodBind77, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind78 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugPathCustomLineWidth, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetDebugPathCustomLineWidth(float lineWidth)
    {
        NativeCalls.godot_icall_1_67(MethodBind78, GodotObject.GetPtr(this), lineWidth);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind79 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugPathCustomLineWidth, 1740695150ul);
    ...
    protected void EmitSignalPathChanged()
    {
        EmitSignal(SignalName.PathChanged);
    }
    ...
    protected void EmitSignalTargetReached()
    {
    ...
    protected void EmitSignalWaypointReached(Godot.Collections.Dictionary details)
    {
        EmitSignal(SignalName.WaypointReached, details);
    }
    ...
    protected void EmitSignalLinkReached(Godot.Collections.Dictionary details)
    {
        EmitSignal(SignalName.LinkReached, details);
    }
    ...
    protected void EmitSignalNavigationFinished()
    {
    ...
    protected void EmitSignalVelocityComputed(Vector2 safeVelocity)
    {
        EmitSignal(SignalName.VelocityComputed, safeVelocity);
    }
...
#pragma warning restore CS0618
    ...
    public new class MethodName : Node.MethodName
    {
        ...
        /// <summary>
        /// Cached name for the 'get_path_length' method.
        /// </summary>
        public static readonly StringName GetPathLength = "get_path_length";
        /// <summary>
