...
public partial class AnimatedSprite3D : SpriteBase3D
{
    ...
    internal AnimatedSprite3D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind11, GodotObject.GetPtr(this), frame);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind13, GodotObject.GetPtr(this), progress);
    }
    ...
    /// <summary>
    /// <para>Sets <see cref="Godot.AnimatedSprite3D.Frame"/> and <see cref="Godot.AnimatedSprite3D.FrameProgress"/> to the given values. Unlike setting <see cref="Godot.AnimatedSprite3D.Frame"/>, this method does not reset the <see cref="Godot.AnimatedSprite3D.FrameProgress"/> to <c>0.0</c> implicitly.</para>
    /// <para><b>Example:</b> Change the animation while keeping the same <see cref="Godot.AnimatedSprite3D.Frame"/> and <see cref="Godot.AnimatedSprite3D.FrameProgress"/>:</para>
    /// <para></para>
    /// </summary>
    public void SetFrameAndProgress(int frame, float progress)
    {
        NativeCalls.godot_icall_2_69(MethodBind15, GodotObject.GetPtr(this), frame, progress);
    }
    ...
    {
        NativeCalls.godot_icall_1_67(MethodBind16, GodotObject.GetPtr(this), speedScale);
    }
