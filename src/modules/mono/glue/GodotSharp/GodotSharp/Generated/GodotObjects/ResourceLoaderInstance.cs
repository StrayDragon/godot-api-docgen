...
public partial class ResourceLoaderInstance : GodotObject
{
    ...
    internal ResourceLoaderInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (Error)NativeCalls.godot_icall_4_1222(MethodBind0, GodotObject.GetPtr(this), path, typeHint, useSubThreads.ToGodotBool(), (int)cacheMode);
    }
    ...
    /// <summary>
    /// <para>Returns the status of a threaded loading operation started with <see cref="Godot.ResourceLoaderInstance.LoadThreadedRequest(string, string, bool, ResourceLoader.CacheMode)"/> for the resource at <paramref name="path"/>.</para>
    ...
    {
        return (ResourceLoader.ThreadLoadStatus)NativeCalls.godot_icall_2_1223(MethodBind1, GodotObject.GetPtr(this), path, (godot_array)(progress ?? new()).NativeValue);
    }
    ...
    {
        return (Resource)NativeCalls.godot_icall_1_533(MethodBind2, GodotObject.GetPtr(this), path);
    }
    ...
    {
        return (Resource)NativeCalls.godot_icall_3_1224(MethodBind3, GodotObject.GetPtr(this), path, typeHint, (int)cacheMode);
    }
    ...
    {
        return NativeCalls.godot_icall_1_328(MethodBind4, GodotObject.GetPtr(this), type);
    }
    ...
    {
        NativeCalls.godot_icall_2_508(MethodBind5, GodotObject.GetPtr(this), GodotObject.GetPtr(formatLoader), atFront.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind6, GodotObject.GetPtr(this), GodotObject.GetPtr(formatLoader));
    }
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind7, GodotObject.GetPtr(this), abort.ToGodotBool());
    }
    ...
    {
        return NativeCalls.godot_icall_1_328(MethodBind8, GodotObject.GetPtr(this), path);
    }
    ...
    {
        return NativeCalls.godot_icall_1_131(MethodBind9, GodotObject.GetPtr(this), path).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind10 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetCachedRef, 1748875256ul);
    ...
    {
        return (Resource)NativeCalls.godot_icall_1_533(MethodBind10, GodotObject.GetPtr(this), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind11 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Exists, 4185558881ul);
    ...
    {
        return NativeCalls.godot_icall_2_327(MethodBind11, GodotObject.GetPtr(this), path, typeHint).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetResourceUid, 1597066294ul);
    ...
    {
        return NativeCalls.godot_icall_1_1225(MethodBind12, GodotObject.GetPtr(this), path);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ListDirectory, 3538744774ul);
    ...
    {
        return NativeCalls.godot_icall_1_328(MethodBind13, GodotObject.GetPtr(this), directoryPath);
    }
