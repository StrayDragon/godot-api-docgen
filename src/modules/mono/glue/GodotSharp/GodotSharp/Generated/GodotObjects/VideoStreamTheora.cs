...
/// <para><b>Note:</b> While Ogg Theora videos can also have a <c>.ogg</c> extension, you will have to rename the extension to <c>.ogv</c> to use those videos within Godot.</para>
/// </summary>
public partial class VideoStreamTheora : VideoStream
{
    ...
    internal VideoStreamTheora(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
