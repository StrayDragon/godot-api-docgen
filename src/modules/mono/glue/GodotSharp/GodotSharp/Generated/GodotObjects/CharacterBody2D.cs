...
public partial class CharacterBody2D : PhysicsBody2D
{
    ...
    /// <summary>
    /// <para>Sets the motion mode which defines the behavior of <see cref="Godot.CharacterBody2D.MoveAndSlide()"/>.</para>
    /// </summary>
    ...
    /// <para><b>Note:</b> A common mistake is setting this property to the desired velocity multiplied by <c>delta</c>, which produces a motion vector in pixels.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Maximum number of times the body can change direction before it stops when calling <see cref="Godot.CharacterBody2D.MoveAndSlide()"/>. Must be greater than zero.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Minimum angle (in radians) where the body is allowed to slide when it encounters a wall. The default value equals 15 degrees. This property only affects movement when <see cref="Godot.CharacterBody2D.MotionMode"/> is <see cref="Godot.CharacterBody2D.MotionModeEnum.Floating"/>.</para>
    /// </summary>
    ...
    internal CharacterBody2D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind2, GodotObject.GetPtr(this), &velocity);
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind27, GodotObject.GetPtr(this), &upDirection);
    }
    ...
    {
        return (CharacterBody2D.MotionModeEnum)NativeCalls.godot_icall_0_39(MethodBind29, GodotObject.GetPtr(this));
    }
    ...
    {
        return (CharacterBody2D.PlatformOnLeaveEnum)NativeCalls.godot_icall_0_39(MethodBind31, GodotObject.GetPtr(this));
    }
    ...
    /// </summary>
    /// <param name="upDirection">If the parameter is null, then the default value is <c>new Vector2(0.0f, -1.0f)</c>.</param>
    public unsafe float GetFloorAngle(Nullable<Vector2> upDirection = null)
    {
        Vector2 upDirectionOrDefVal = upDirection.HasValue ? upDirection.Value : new Vector2(0.0f, -1.0f);
        return NativeCalls.godot_icall_1_287(MethodBind43, GodotObject.GetPtr(this), &upDirectionOrDefVal);
    }
    ...
    {
        return (KinematicCollision2D)NativeCalls.godot_icall_1_71(MethodBind46, GodotObject.GetPtr(this), slideIdx);
    }
    ...
    /// <summary>
    /// <para>Returns a <see cref="Godot.KinematicCollision2D"/> if a collision occurred. The returned value contains information about the latest collision that occurred during the last call to <see cref="Godot.CharacterBody2D.MoveAndSlide()"/>. Returns <see langword="null"/> if no collision occurred. See also <see cref="Godot.CharacterBody2D.GetSlideCollision(int)"/>.</para>
    /// </summary>
    public KinematicCollision2D GetLastSlideCollision()
    {
        return (KinematicCollision2D)NativeCalls.godot_icall_0_63(MethodBind47, GodotObject.GetPtr(this));
    }
