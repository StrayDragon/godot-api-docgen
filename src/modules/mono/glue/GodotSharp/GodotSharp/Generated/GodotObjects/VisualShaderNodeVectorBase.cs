...
public partial class VisualShaderNodeVectorBase : VisualShaderNode
{
    ...
    internal VisualShaderNodeVectorBase(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeVectorBase.OpTypeEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
