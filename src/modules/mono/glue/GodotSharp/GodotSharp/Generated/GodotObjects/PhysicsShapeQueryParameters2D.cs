...
#nullable disable
/// <summary>
/// <para>By changing various properties of this object, such as the shape, you can configure the parameters for <see cref="Godot.PhysicsDirectSpaceState2D"/>'s methods.</para>
/// </summary>
public partial class PhysicsShapeQueryParameters2D : RefCounted
{
    ...
    internal PhysicsShapeQueryParameters2D(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_218(MethodBind4, GodotObject.GetPtr(this), &transform);
    }
    ...
    {
        return NativeCalls.godot_icall_0_219(MethodBind5, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind6, GodotObject.GetPtr(this), &motion);
    }
