...
#nullable disable
/// <summary>
/// <para>Provides access to metadata stored for every available engine class.</para>
/// <para><b>Note:</b> Script-defined classes with <c>class_name</c> are not part of <see cref="Godot.ClassDB"/>, so they will not return reflection data such as a method or property list. However, <see cref="Godot.GDExtension"/>-defined classes <i>are</i> part of <see cref="Godot.ClassDB"/>, so they will return reflection data.</para>
/// </summary>
public static partial class ClassDB
{
    ...
    {
        /// <summary>
        /// <para>Native Core class type.</para>
        /// </summary>
        Core = 0,
        /// <summary>
        /// <para>Native Editor class type.</para>
        /// </summary>
        Editor = 1,
        /// <summary>
        /// <para>GDExtension class type.</para>
        /// </summary>
        Extension = 2,
        /// <summary>
        /// <para>GDExtension Editor class type.</para>
        /// </summary>
        EditorExtension = 3,
        /// <summary>
        /// <para>Unknown class type.</para>
        /// </summary>
        None = 4
    }
    ...
    /// <summary>
    /// <para>Returns the names of all engine classes available.</para>
    /// <para><b>Note:</b> Script-defined classes with <c>class_name</c> are not included in this list. Use <see cref="Godot.ProjectSettings.GetGlobalClassList()"/> to get a list of script-defined classes instead.</para>
    /// </summary>
    public static string[] GetClassList()
    {
        return NativeCalls.godot_icall_0_108(MethodBind0, GodotObject.GetPtr(Singleton));
    }
    ...
    /// <summary>
    /// <para>Returns the names of all engine classes that directly or indirectly inherit from <paramref name="class"/>.</para>
    /// </summary>
    public static string[] GetInheritersFromClass(StringName @class)
    {
        return NativeCalls.godot_icall_1_289(MethodBind1, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default));
    }
    ...
    {
        return NativeCalls.godot_icall_1_164(MethodBind2, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default));
    }
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind3, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_2_160(MethodBind4, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(inherits?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind5, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_1_143(MethodBind6, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind7 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetApiType, 2475317043ul);

    /// <summary>
    /// <para>Returns the API type of the specified <paramref name="class"/>.</para>
    /// </summary>
    public static ClassDB.ApiType ClassGetApiType(StringName @class)
    {
        return (ClassDB.ApiType)NativeCalls.godot_icall_1_193(MethodBind7, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind8 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassHasSignal, 471820014ul);
    ...
    {
        return NativeCalls.godot_icall_2_160(MethodBind8, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(signal?.NativeValue ?? default)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind9 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetSignal, 3061114238ul);
    ...
    {
        return NativeCalls.godot_icall_2_290(MethodBind9, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(signal?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind10 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetSignalList, 3504980660ul);
    ...
    {
        return new Godot.Collections.Array<Godot.Collections.Dictionary>(NativeCalls.godot_icall_2_291(MethodBind10, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), noInheritance.ToGodotBool()));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind11 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetPropertyList, 3504980660ul);
    ...
    {
        return new Godot.Collections.Array<Godot.Collections.Dictionary>(NativeCalls.godot_icall_2_291(MethodBind11, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), noInheritance.ToGodotBool()));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetPropertyGetter, 3770832642ul);

    /// <summary>
    /// <para>Returns the getter method name of <paramref name="property"/> of <paramref name="class"/>.</para>
    /// </summary>
    public static StringName ClassGetPropertyGetter(StringName @class, StringName property)
    {
        return NativeCalls.godot_icall_2_292(MethodBind12, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(property?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind13 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetPropertySetter, 3770832642ul);

    /// <summary>
    /// <para>Returns the setter method name of <paramref name="property"/> of <paramref name="class"/>.</para>
    /// </summary>
    public static StringName ClassGetPropertySetter(StringName @class, StringName property)
    {
        return NativeCalls.godot_icall_2_292(MethodBind13, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(property?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind14 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetProperty, 2498641674ul);
    ...
    {
        return NativeCalls.godot_icall_2_293(MethodBind14, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(@object), (godot_string_name)(property?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind15 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassSetProperty, 1690314931ul);
    ...
    {
        return (Error)NativeCalls.godot_icall_3_294(MethodBind15, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(@object), (godot_string_name)(property?.NativeValue ?? default), value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind16 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetPropertyDefaultValue, 2718203076ul);
    ...
    {
        return NativeCalls.godot_icall_2_295(MethodBind16, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(property?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind17 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassHasMethod, 3860701026ul);
    ...
    {
        return NativeCalls.godot_icall_3_296(MethodBind17, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(method?.NativeValue ?? default), noInheritance.ToGodotBool()).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind18 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetMethodArgumentCount, 3885694822ul);
    ...
    {
        return NativeCalls.godot_icall_3_297(MethodBind18, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(method?.NativeValue ?? default), noInheritance.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind19 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetMethodList, 3504980660ul);
    ...
    {
        return new Godot.Collections.Array<Godot.Collections.Dictionary>(NativeCalls.godot_icall_2_291(MethodBind19, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), noInheritance.ToGodotBool()));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind20 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassCallStatic, 3344196419ul);

    /// <summary>
    /// <para>Calls a static method on a class.</para>
    /// </summary>
    public static Variant ClassCallStatic(StringName @class, StringName method, params Variant[] @args)
    {
        return NativeCalls.godot_icall_3_298(MethodBind20, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(method?.NativeValue ?? default), @args, (godot_string_name)MethodName.ClassCallStatic.NativeValue);
    }

    /// <summary>
    /// <para>Calls a static method on a class.</para>
    /// </summary>
    public static Variant ClassCallStatic(StringName @class, StringName method, ReadOnlySpan<Variant> @args)
    {
        return NativeCalls.godot_icall_3_298(MethodBind20, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(method?.NativeValue ?? default), @args, (godot_string_name)MethodName.ClassCallStatic.NativeValue);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind21 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetIntegerConstantList, 3031669221ul);
    ...
    {
        return NativeCalls.godot_icall_2_299(MethodBind21, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), noInheritance.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind22 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassHasIntegerConstant, 471820014ul);
    ...
    {
        return NativeCalls.godot_icall_2_160(MethodBind22, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(name?.NativeValue ?? default)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind23 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetIntegerConstant, 2419549490ul);
    ...
    {
        return NativeCalls.godot_icall_2_300(MethodBind23, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(name?.NativeValue ?? default));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind24 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassHasEnum, 3860701026ul);
    ...
    {
        return NativeCalls.godot_icall_3_296(MethodBind24, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(name?.NativeValue ?? default), noInheritance.ToGodotBool()).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind25 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetEnumList, 3031669221ul);
    ...
    {
        return NativeCalls.godot_icall_2_299(MethodBind25, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), noInheritance.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind26 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetEnumConstants, 661528303ul);
    ...
    {
        return NativeCalls.godot_icall_3_301(MethodBind26, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(@enum?.NativeValue ?? default), noInheritance.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind27 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ClassGetIntegerConstantEnum, 2457504236ul);
    ...
    {
        return NativeCalls.godot_icall_3_302(MethodBind27, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(name?.NativeValue ?? default), noInheritance.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind28 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.IsClassEnumBitfield, 3860701026ul);
    ...
    {
        return NativeCalls.godot_icall_3_296(MethodBind28, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default), (godot_string_name)(@enum?.NativeValue ?? default), noInheritance.ToGodotBool()).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind29 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.IsClassEnabled, 2619796661ul);
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind29, GodotObject.GetPtr(Singleton), (godot_string_name)(@class?.NativeValue ?? default)).ToBool();
    }
    ...
    public class MethodName
    {
        ...
        /// <summary>
        /// Cached name for the 'class_get_api_type' method.
        /// </summary>
        public static readonly StringName ClassGetApiType = "class_get_api_type";
        /// <summary>
        ...
        /// <summary>
        /// Cached name for the 'class_get_property_getter' method.
        /// </summary>
        public static readonly StringName ClassGetPropertyGetter = "class_get_property_getter";
        /// <summary>
        /// Cached name for the 'class_get_property_setter' method.
        /// </summary>
        public static readonly StringName ClassGetPropertySetter = "class_get_property_setter";
        /// <summary>
        ...
        /// <summary>
        /// Cached name for the 'class_call_static' method.
        /// </summary>
        public static readonly StringName ClassCallStatic = "class_call_static";
        /// <summary>
