...
public partial class NavigationMeshGeneratorInstance : GodotObject
{
    ...
    internal NavigationMeshGeneratorInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_2_239(MethodBind0, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(rootNode));
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ParseSourceGeometryData, 3172802542ul);
    ...
    {
        NativeCalls.godot_icall_4_836(MethodBind2, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), GodotObject.GetPtr(rootNode), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind3 = ClassDB_get_method_with_compatibility(NativeName, MethodName.BakeFromSourceGeometryData, 1286748856ul);
    ...
    {
        NativeCalls.godot_icall_3_837(MethodBind3, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), callback);
    }
