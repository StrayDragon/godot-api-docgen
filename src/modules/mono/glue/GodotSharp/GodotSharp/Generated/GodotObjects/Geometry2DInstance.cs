...
public partial class Geometry2DInstance : GodotObject
{
    ...
    internal Geometry2DInstance(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return NativeCalls.godot_icall_3_659(MethodBind0, GodotObject.GetPtr(this), &point, &circlePosition, circleRadius).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_4_660(MethodBind1, GodotObject.GetPtr(this), &segmentFrom, &segmentTo, &circlePosition, circleRadius);
    }
    ...
    {
        return NativeCalls.godot_icall_4_661(MethodBind2, GodotObject.GetPtr(this), &fromA, &toA, &fromB, &toB);
    }
    ...
    /// <summary>
    /// <para>Returns the point of intersection between the two lines (<paramref name="fromA"/>, <paramref name="dirA"/>) and (<paramref name="fromB"/>, <paramref name="dirB"/>). Returns a <see cref="Godot.Vector2"/>, or <see langword="null"/> if the lines are parallel.</para>
    /// <para><c>from</c> and <c>dir</c> are <i>not</i> endpoints of a line segment or ray but the slope (<c>dir</c>) and a known point (<c>from</c>) on that line.</para>
    /// <para><code>
    ...
    {
        return NativeCalls.godot_icall_4_661(MethodBind3, GodotObject.GetPtr(this), &fromA, &dirA, &fromB, &dirB);
    }
    ...
    {
        return NativeCalls.godot_icall_4_662(MethodBind4, GodotObject.GetPtr(this), &p1, &q1, &p2, &q2);
    }
    ...
    {
        return NativeCalls.godot_icall_3_663(MethodBind5, GodotObject.GetPtr(this), &point, &s1, &s2);
    }
    ...
    {
        return NativeCalls.godot_icall_3_663(MethodBind6, GodotObject.GetPtr(this), &point, &s1, &s2);
    }
    ...
    {
        return NativeCalls.godot_icall_4_664(MethodBind7, GodotObject.GetPtr(this), &point, &a, &b, &c).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_1_200(MethodBind8, GodotObject.GetPtr(this), polygon).ToBool();
    }
    ...
    /// <para><b>Note:</b> Assumes a Cartesian coordinate system where <c>+x</c> is right and <c>+y</c> is up. If using screen coordinates (<c>+y</c> is down), the result will need to be flipped (i.e. a <see langword="true"/> result will indicate counter-clockwise).</para>
    /// </summary>
    public bool IsPolygonClockwise(ReadOnlySpan<Vector2> polygon)
    {
        return NativeCalls.godot_icall_1_200(MethodBind8, GodotObject.GetPtr(this), polygon).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_2_665(MethodBind9, GodotObject.GetPtr(this), &point, polygon).ToBool();
    }

    /// <summary>
    /// <para>Returns <see langword="true"/> if <paramref name="point"/> is inside <paramref name="polygon"/> or if it's located exactly <i>on</i> polygon's boundary, otherwise returns <see langword="false"/>.</para>
    /// </summary>
    public unsafe bool IsPointInPolygon(Vector2 point, ReadOnlySpan<Vector2> polygon)
    {
        return NativeCalls.godot_icall_2_665(MethodBind9, GodotObject.GetPtr(this), &point, polygon).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_1_666(MethodBind10, GodotObject.GetPtr(this), polygon);
    }

    /// <summary>
    /// <para>Triangulates the polygon specified by the points in <paramref name="polygon"/>. Returns a <see cref="int"/>[] where each triangle consists of three consecutive point indices into <paramref name="polygon"/> (i.e. the returned array will have <c>n * 3</c> elements, with <c>n</c> being the number of found triangles). Output triangles will always be counter clockwise, and the contour will be flipped if it's clockwise. If the triangulation did not succeed, an empty <see cref="int"/>[] is returned.</para>
    /// </summary>
    public int[] TriangulatePolygon(ReadOnlySpan<Vector2> polygon)
    {
        return NativeCalls.godot_icall_1_666(MethodBind10, GodotObject.GetPtr(this), polygon);
    }
    ...
    {
        return NativeCalls.godot_icall_1_666(MethodBind11, GodotObject.GetPtr(this), points);
    }

    /// <summary>
    /// <para>Triangulates the area specified by discrete set of <paramref name="points"/> such that no point is inside the circumcircle of any resulting triangle. Returns a <see cref="int"/>[] where each triangle consists of three consecutive point indices into <paramref name="points"/> (i.e. the returned array will have <c>n * 3</c> elements, with <c>n</c> being the number of found triangles). If the triangulation did not succeed, an empty <see cref="int"/>[] is returned.</para>
    /// </summary>
    public int[] TriangulateDelaunay(ReadOnlySpan<Vector2> points)
    {
        return NativeCalls.godot_icall_1_666(MethodBind11, GodotObject.GetPtr(this), points);
    }
    ...
    {
        return NativeCalls.godot_icall_1_667(MethodBind12, GodotObject.GetPtr(this), points);
    }

    /// <summary>
    /// <para>Given an array of <see cref="Godot.Vector2"/>s, returns the convex hull as a list of points in counterclockwise order. The last point is the same as the first one.</para>
    /// </summary>
    public Vector2[] ConvexHull(ReadOnlySpan<Vector2> points)
    {
        return NativeCalls.godot_icall_1_667(MethodBind12, GodotObject.GetPtr(this), points);
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_1_668(MethodBind13, GodotObject.GetPtr(this), polygon));
    }

    /// <summary>
    /// <para>Decomposes the <paramref name="polygon"/> into multiple convex hulls and returns an array of <see cref="Godot.Vector2"/>[].</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> DecomposePolygonInConvex(ReadOnlySpan<Vector2> polygon)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_1_668(MethodBind13, GodotObject.GetPtr(this), polygon));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind14, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    /// <para>The operation may result in an outer polygon (boundary) and multiple inner polygons (holes) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> MergePolygons(ReadOnlySpan<Vector2> polygonA, ReadOnlySpan<Vector2> polygonB)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind14, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind15, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    /// <para>If <paramref name="polygonB"/> is enclosed by <paramref name="polygonA"/>, returns an outer polygon (boundary) and inner polygon (hole) which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> ClipPolygons(ReadOnlySpan<Vector2> polygonA, ReadOnlySpan<Vector2> polygonB)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind15, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind16, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    /// <para>The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> IntersectPolygons(ReadOnlySpan<Vector2> polygonA, ReadOnlySpan<Vector2> polygonB)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind16, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind17, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    /// <para>The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> ExcludePolygons(ReadOnlySpan<Vector2> polygonA, ReadOnlySpan<Vector2> polygonB)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind17, GodotObject.GetPtr(this), polygonA, polygonB));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind18, GodotObject.GetPtr(this), polyline, polygon));
    }

    /// <summary>
    /// <para>Clips <paramref name="polyline"/> against <paramref name="polygon"/> and returns an array of clipped polylines. This performs <see cref="Godot.Geometry2D.PolyBooleanOperation.Difference"/> between the polyline and the polygon. This operation can be thought of as cutting a line with a closed shape.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> ClipPolylineWithPolygon(ReadOnlySpan<Vector2> polyline, ReadOnlySpan<Vector2> polygon)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind18, GodotObject.GetPtr(this), polyline, polygon));
    }
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind19, GodotObject.GetPtr(this), polyline, polygon));
    }

    /// <summary>
    /// <para>Intersects <paramref name="polyline"/> with <paramref name="polygon"/> and returns an array of intersected polylines. This performs <see cref="Godot.Geometry2D.PolyBooleanOperation.Intersection"/> between the polyline and the polygon. This operation can be thought of as chopping a line with a closed shape.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> IntersectPolylineWithPolygon(ReadOnlySpan<Vector2> polyline, ReadOnlySpan<Vector2> polygon)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_2_669(MethodBind19, GodotObject.GetPtr(this), polyline, polygon));
    }
    ...
    /// <para>Each polygon's vertices will be rounded as determined by <paramref name="joinType"/>.</para>
    /// <para>The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_3_670(MethodBind20, GodotObject.GetPtr(this), polygon, delta, (int)joinType));
    }
    ...
    /// </code></para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> OffsetPolygon(ReadOnlySpan<Vector2> polygon, float delta, Geometry2D.PolyJoinType joinType)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_3_670(MethodBind20, GodotObject.GetPtr(this), polygon, delta, (int)joinType));
    }
    ...
    /// <para>Each polygon's vertices will be rounded as determined by <paramref name="joinType"/>.</para>
    /// <para>Each polygon's endpoints will be rounded as determined by <paramref name="endType"/>.</para>
    /// <para>The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    ...
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_4_671(MethodBind21, GodotObject.GetPtr(this), polyline, delta, (int)joinType, (int)endType));
    }
    ...
    /// <para>The operation may result in an outer polygon (boundary) and inner polygon (hole) produced which could be distinguished by calling <see cref="Godot.Geometry2DInstance.IsPolygonClockwise(Vector2[])"/>.</para>
    /// </summary>
    public Godot.Collections.Array<Vector2[]> OffsetPolyline(ReadOnlySpan<Vector2> polyline, float delta, Geometry2D.PolyJoinType joinType, Geometry2D.PolyEndType endType)
    {
        return new Godot.Collections.Array<Vector2[]>(NativeCalls.godot_icall_4_671(MethodBind21, GodotObject.GetPtr(this), polyline, delta, (int)joinType, (int)endType));
    }
    ...
    {
        return NativeCalls.godot_icall_1_672(MethodBind22, GodotObject.GetPtr(this), sizes);
    }

    /// <summary>
    /// <para>Given an array of <see cref="Godot.Vector2"/>s representing tiles, builds an atlas. The returned dictionary has two keys: <c>points</c> is a <see cref="Godot.Vector2"/>[] that specifies the positions of each tile, <c>size</c> contains the overall size of the whole atlas as <see cref="Godot.Vector2I"/>.</para>
    /// </summary>
    public Godot.Collections.Dictionary MakeAtlas(ReadOnlySpan<Vector2> sizes)
    {
        return NativeCalls.godot_icall_1_672(MethodBind22, GodotObject.GetPtr(this), sizes);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind23 = ClassDB_get_method_with_compatibility(NativeName, MethodName.BresenhamLine, 1989391000ul);

    /// <summary>
    /// <para>Returns the <a href="https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm">Bresenham line</a> between the <paramref name="from"/> and <paramref name="to"/> points. A Bresenham line is a series of pixels that draws a line and is always 1-pixel thick on every row and column of the drawing (never more, never less).</para>
    /// <para>Example code to draw a line between two <see cref="Godot.Marker2D"/> nodes using a series of <see cref="Godot.CanvasItem.DrawRect(Rect2, Color, bool, float, bool)"/> calls:</para>
    /// <para><code>
    /// func _draw():
    ...
    /// </code></para>
    /// </summary>
    public unsafe Godot.Collections.Array<Vector2I> BresenhamLine(Vector2I from, Vector2I to)
    {
        return new Godot.Collections.Array<Vector2I>(NativeCalls.godot_icall_2_52(MethodBind23, GodotObject.GetPtr(this), &from, &to));
    }
...
#pragma warning restore CS0618
    ...
    public new class MethodName : GodotObject.MethodName
    {
        ...
        /// <summary>
        /// Cached name for the 'bresenham_line' method.
        /// </summary>
        public static readonly StringName BresenhamLine = "bresenham_line";
    }
