...
public static partial class NavigationServer3D
{
    public enum ProcessInfo : long
    {
        ...
        EdgeFreeCount = 8,
        /// <summary>
        /// <para>Constant to get the number of active navigation obstacles.</para>
        /// </summary>
        ObstacleCount = 9
    }
    ...
    {
        return new Godot.Collections.Array<Rid>(NativeCalls.godot_icall_0_120(MethodBind0, GodotObject.GetPtr(Singleton)));
    }
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind1, GodotObject.GetPtr(Singleton));
    }
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind2, GodotObject.GetPtr(Singleton), map, active.ToGodotBool());
    }
    ...
    /// <summary>
    /// <para>Returns <see langword="true"/> if the map is active.</para>
    /// </summary>
    public static bool MapIsActive(Rid map)
    {
        return NativeCalls.godot_icall_1_421(MethodBind3, GodotObject.GetPtr(Singleton), map).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind4, GodotObject.GetPtr(Singleton), map, &up);
    }
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind5, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind6, GodotObject.GetPtr(Singleton), map, cellSize);
    }
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind7, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind8, GodotObject.GetPtr(Singleton), map, cellHeight);
    }
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind9, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind10, GodotObject.GetPtr(Singleton), map, scale);
    }
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind11, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind12, GodotObject.GetPtr(Singleton), map, enabled.ToGodotBool());
    }
    ...
    /// <summary>
    /// <para>Returns <see langword="true"/> if the navigation <paramref name="map"/> allows navigation regions to use edge connections to connect with other navigation regions within proximity of the navigation map edge connection margin.</para>
    /// </summary>
    public static bool MapGetUseEdgeConnections(Rid map)
    {
        return NativeCalls.godot_icall_1_421(MethodBind13, GodotObject.GetPtr(Singleton), map).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind14, GodotObject.GetPtr(Singleton), map, margin);
    }
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind15, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind16, GodotObject.GetPtr(Singleton), map, radius);
    }
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind17, GodotObject.GetPtr(Singleton), map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind18 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.MapGetPath, 276783190ul);
    ...
    {
        return NativeCalls.godot_icall_5_867(MethodBind18, GodotObject.GetPtr(Singleton), map, &origin, &destination, optimize.ToGodotBool(), navigationLayers);
    }
    ...
    /// <summary>
    /// <para>Returns the navigation mesh surface point closest to the provided <paramref name="start"/> and <paramref name="end"/> segment on the navigation <paramref name="map"/>.</para>
    /// <para>If <paramref name="useCollision"/> is <see langword="true"/>, a closest point test is only done when the segment intersects with the navigation mesh surface.</para>
    /// </summary>
    public static unsafe Vector3 MapGetClosestPointToSegment(Rid map, Vector3 start, Vector3 end, bool useCollision = false)
    {
        return NativeCalls.godot_icall_4_868(MethodBind19, GodotObject.GetPtr(Singleton), map, &start, &end, useCollision.ToGodotBool());
    }
    ...
    /// <summary>
    /// <para>Returns the navigation mesh surface point closest to the provided <paramref name="toPoint"/> on the navigation <paramref name="map"/>.</para>
    /// </summary>
    public static unsafe Vector3 MapGetClosestPoint(Rid map, Vector3 toPoint)
    {
        return NativeCalls.godot_icall_2_869(MethodBind20, GodotObject.GetPtr(Singleton), map, &toPoint);
    }
    ...
    /// <summary>
    /// <para>Returns the navigation mesh surface normal closest to the provided <paramref name="toPoint"/> on the navigation <paramref name="map"/>.</para>
    /// </summary>
    public static unsafe Vector3 MapGetClosestPointNormal(Rid map, Vector3 toPoint)
    {
        return NativeCalls.godot_icall_2_869(MethodBind21, GodotObject.GetPtr(Singleton), map, &toPoint);
    }
    ...
    /// <summary>
    /// <para>Returns the owner region RID for the navigation mesh surface point closest to the provided <paramref name="toPoint"/> on the navigation <paramref name="map"/>.</para>
    /// </summary>
    public static unsafe Rid MapGetClosestPointOwner(Rid map, Vector3 toPoint)
    {
        return NativeCalls.godot_icall_2_870(MethodBind22, GodotObject.GetPtr(Singleton), map, &toPoint);
    }
    ...
    {
        return new Godot.Collections.Array<Rid>(NativeCalls.godot_icall_1_849(MethodBind23, GodotObject.GetPtr(Singleton), map));
    }
    ...
    {
        return new Godot.Collections.Array<Rid>(NativeCalls.godot_icall_1_849(MethodBind24, GodotObject.GetPtr(Singleton), map));
    }
    ...
    {
        return new Godot.Collections.Array<Rid>(NativeCalls.godot_icall_1_849(MethodBind25, GodotObject.GetPtr(Singleton), map));
    }
    ...
    {
        return new Godot.Collections.Array<Rid>(NativeCalls.godot_icall_1_849(MethodBind26, GodotObject.GetPtr(Singleton), map));
    }
    ...
    /// </summary>
    [Obsolete("This method is no longer supported, as it is incompatible with asynchronous updates. It can only be used in a single-threaded context, at your own risk.")]
    public static void MapForceUpdate(Rid map)
    {
        NativeCalls.godot_icall_1_286(MethodBind27, GodotObject.GetPtr(Singleton), map);
    }
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind28, GodotObject.GetPtr(Singleton), map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind29 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.MapSetUseAsyncIterations, 1265174801ul);

    /// <summary>
    /// <para>If <paramref name="enabled"/> is <see langword="true"/> the <paramref name="map"/> synchronization uses an async process that runs on a background thread.</para>
    /// </summary>
    public static void MapSetUseAsyncIterations(Rid map, bool enabled)
    {
        NativeCalls.godot_icall_2_434(MethodBind29, GodotObject.GetPtr(Singleton), map, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind30 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.MapGetUseAsyncIterations, 4155700596ul);

    /// <summary>
    /// <para>Returns <see langword="true"/> if the <paramref name="map"/> synchronization uses an async process that runs on a background thread.</para>
    /// </summary>
    public static bool MapGetUseAsyncIterations(Rid map)
    {
        return NativeCalls.godot_icall_1_421(MethodBind30, GodotObject.GetPtr(Singleton), map).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind31 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.MapGetRandomPoint, 722801526ul);
    ...
    {
        return NativeCalls.godot_icall_3_871(MethodBind31, GodotObject.GetPtr(Singleton), map, navigationLayers, uniformly.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind32 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.QueryPath, 2146930868ul);

    /// <summary>
    /// <para>Queries a path in a given navigation map. Start and target position and other parameters are defined through <see cref="Godot.NavigationPathQueryParameters3D"/>. Updates the provided <see cref="Godot.NavigationPathQueryResult3D"/> result object with the path among other results requested by the query. After the process is finished the optional <paramref name="callback"/> will be called.</para>
    /// </summary>
    public static void QueryPath(NavigationPathQueryParameters3D parameters, NavigationPathQueryResult3D result, Callable callback = default)
    {
        NativeCalls.godot_icall_3_837(MethodBind32, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(parameters), GodotObject.GetPtr(result), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind33 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionCreate, 529393457ul);
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind33, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind34 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetIterationId, 2198884583ul);

    /// <summary>
    /// <para>Returns the current iteration ID of the navigation region. Every time the navigation region changes and synchronizes, the iteration ID increases. An iteration ID of <c>0</c> means the navigation region has never synchronized.</para>
    /// <para><b>Note:</b> The iteration ID will wrap around to <c>1</c> after reaching its range limit.</para>
    /// </summary>
    public static uint RegionGetIterationId(Rid region)
    {
        return NativeCalls.godot_icall_1_850(MethodBind34, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind35 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetUseAsyncIterations, 1265174801ul);

    /// <summary>
    /// <para>If <paramref name="enabled"/> is <see langword="true"/> the <paramref name="region"/> uses an async synchronization process that runs on a background thread.</para>
    /// </summary>
    public static void RegionSetUseAsyncIterations(Rid region, bool enabled)
    {
        NativeCalls.godot_icall_2_434(MethodBind35, GodotObject.GetPtr(Singleton), region, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind36 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetUseAsyncIterations, 4155700596ul);

    /// <summary>
    /// <para>Returns <see langword="true"/> if the <paramref name="region"/> uses an async synchronization process that runs on a background thread.</para>
    /// </summary>
    public static bool RegionGetUseAsyncIterations(Rid region)
    {
        return NativeCalls.godot_icall_1_421(MethodBind36, GodotObject.GetPtr(Singleton), region).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind37 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetEnabled, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind37, GodotObject.GetPtr(Singleton), region, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind38 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetEnabled, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind38, GodotObject.GetPtr(Singleton), region).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind39 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetUseEdgeConnections, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind39, GodotObject.GetPtr(Singleton), region, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind40 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetUseEdgeConnections, 4155700596ul);

    /// <summary>
    /// <para>Returns <see langword="true"/> if the navigation <paramref name="region"/> is set to use edge connections to connect with other navigation regions within proximity of the navigation map edge connection margin.</para>
    /// </summary>
    public static bool RegionGetUseEdgeConnections(Rid region)
    {
        return NativeCalls.godot_icall_1_421(MethodBind40, GodotObject.GetPtr(Singleton), region).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind41 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetEnterCost, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind41, GodotObject.GetPtr(Singleton), region, enterCost);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind42 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetEnterCost, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind42, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind43 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetTravelCost, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind43, GodotObject.GetPtr(Singleton), region, travelCost);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind44 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetTravelCost, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind44, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind45 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetOwnerId, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_852(MethodBind45, GodotObject.GetPtr(Singleton), region, ownerId);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind46 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetOwnerId, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_853(MethodBind46, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind47 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionOwnsPoint, 2360011153ul);
    ...
    {
        return NativeCalls.godot_icall_2_872(MethodBind47, GodotObject.GetPtr(Singleton), region, &point).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind48 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetMap, 395945892ul);
    ...
    {
        NativeCalls.godot_icall_2_430(MethodBind48, GodotObject.GetPtr(Singleton), region, map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind49 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetMap, 3814569979ul);
    ...
    {
        return NativeCalls.godot_icall_1_855(MethodBind49, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind50 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetNavigationLayers, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_856(MethodBind50, GodotObject.GetPtr(Singleton), region, navigationLayers);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind51 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetNavigationLayers, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind51, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind52 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetTransform, 3935195649ul);
    ...
    {
        NativeCalls.godot_icall_2_873(MethodBind52, GodotObject.GetPtr(Singleton), region, &transform);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind53 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetTransform, 1128465797ul);
    ...
    {
        return NativeCalls.godot_icall_1_874(MethodBind53, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind54 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionSetNavigationMesh, 2764952978ul);
    ...
    {
        NativeCalls.godot_icall_2_858(MethodBind54, GodotObject.GetPtr(Singleton), region, GodotObject.GetPtr(navigationMesh));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind55 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionBakeNavigationMesh, 1401173477ul);
    ...
    {
        NativeCalls.godot_icall_2_239(MethodBind55, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(rootNode));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind56 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetConnectionsCount, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_835(MethodBind56, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind57 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetConnectionPathwayStart, 3440143363ul);
    ...
    {
        return NativeCalls.godot_icall_2_875(MethodBind57, GodotObject.GetPtr(Singleton), region, connection);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind58 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetConnectionPathwayEnd, 3440143363ul);
    ...
    {
        return NativeCalls.godot_icall_2_875(MethodBind58, GodotObject.GetPtr(Singleton), region, connection);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind59 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetClosestPointToSegment, 3830095642ul);

    /// <summary>
    /// <para>Returns the navigation mesh surface point closest to the provided <paramref name="start"/> and <paramref name="end"/> segment on the navigation <paramref name="region"/>.</para>
    /// <para>If <paramref name="useCollision"/> is <see langword="true"/>, a closest point test is only done when the segment intersects with the navigation mesh surface.</para>
    /// </summary>
    public static unsafe Vector3 RegionGetClosestPointToSegment(Rid region, Vector3 start, Vector3 end, bool useCollision = false)
    {
        return NativeCalls.godot_icall_4_868(MethodBind59, GodotObject.GetPtr(Singleton), region, &start, &end, useCollision.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind60 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetClosestPoint, 2056183332ul);

    /// <summary>
    /// <para>Returns the navigation mesh surface point closest to the provided <paramref name="toPoint"/> on the navigation <paramref name="region"/>.</para>
    /// </summary>
    public static unsafe Vector3 RegionGetClosestPoint(Rid region, Vector3 toPoint)
    {
        return NativeCalls.godot_icall_2_869(MethodBind60, GodotObject.GetPtr(Singleton), region, &toPoint);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind61 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetClosestPointNormal, 2056183332ul);

    /// <summary>
    /// <para>Returns the navigation mesh surface normal closest to the provided <paramref name="toPoint"/> on the navigation <paramref name="region"/>.</para>
    /// </summary>
    public static unsafe Vector3 RegionGetClosestPointNormal(Rid region, Vector3 toPoint)
    {
        return NativeCalls.godot_icall_2_869(MethodBind61, GodotObject.GetPtr(Singleton), region, &toPoint);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind62 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetRandomPoint, 722801526ul);
    ...
    {
        return NativeCalls.godot_icall_3_871(MethodBind62, GodotObject.GetPtr(Singleton), region, navigationLayers, uniformly.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind63 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.RegionGetBounds, 974181306ul);

    /// <summary>
    /// <para>Returns the axis-aligned bounding box for the <paramref name="region"/>'s transformed navigation mesh.</para>
    /// </summary>
    public static Aabb RegionGetBounds(Rid region)
    {
        return NativeCalls.godot_icall_1_876(MethodBind63, GodotObject.GetPtr(Singleton), region);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind64 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkCreate, 529393457ul);
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind64, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind65 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetIterationId, 2198884583ul);

    /// <summary>
    /// <para>Returns the current iteration ID of the navigation link. Every time the navigation link changes and synchronizes, the iteration ID increases. An iteration ID of <c>0</c> means the navigation link has never synchronized.</para>
    /// <para><b>Note:</b> The iteration ID will wrap around to <c>1</c> after reaching its range limit.</para>
    /// </summary>
    public static uint LinkGetIterationId(Rid link)
    {
        return NativeCalls.godot_icall_1_850(MethodBind65, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind66 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetMap, 395945892ul);
    ...
    {
        NativeCalls.godot_icall_2_430(MethodBind66, GodotObject.GetPtr(Singleton), link, map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind67 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetMap, 3814569979ul);
    ...
    {
        return NativeCalls.godot_icall_1_855(MethodBind67, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind68 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetEnabled, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind68, GodotObject.GetPtr(Singleton), link, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind69 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetEnabled, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind69, GodotObject.GetPtr(Singleton), link).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind70 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetBidirectional, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind70, GodotObject.GetPtr(Singleton), link, bidirectional.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind71 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkIsBidirectional, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind71, GodotObject.GetPtr(Singleton), link).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind72 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetNavigationLayers, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_856(MethodBind72, GodotObject.GetPtr(Singleton), link, navigationLayers);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind73 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetNavigationLayers, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind73, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind74 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetStartPosition, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind74, GodotObject.GetPtr(Singleton), link, &position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind75 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetStartPosition, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind75, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind76 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetEndPosition, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind76, GodotObject.GetPtr(Singleton), link, &position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind77 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetEndPosition, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind77, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind78 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetEnterCost, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind78, GodotObject.GetPtr(Singleton), link, enterCost);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind79 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetEnterCost, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind79, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind80 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetTravelCost, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind80, GodotObject.GetPtr(Singleton), link, travelCost);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind81 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetTravelCost, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind81, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind82 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkSetOwnerId, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_852(MethodBind82, GodotObject.GetPtr(Singleton), link, ownerId);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind83 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.LinkGetOwnerId, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_853(MethodBind83, GodotObject.GetPtr(Singleton), link);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind84 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentCreate, 529393457ul);
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind84, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind85 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetAvoidanceEnabled, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind85, GodotObject.GetPtr(Singleton), agent, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind86 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetAvoidanceEnabled, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind86, GodotObject.GetPtr(Singleton), agent).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind87 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetUse3DAvoidance, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind87, GodotObject.GetPtr(Singleton), agent, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind88 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetUse3DAvoidance, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind88, GodotObject.GetPtr(Singleton), agent).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind89 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetMap, 395945892ul);
    ...
    {
        NativeCalls.godot_icall_2_430(MethodBind89, GodotObject.GetPtr(Singleton), agent, map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind90 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetMap, 3814569979ul);
    ...
    {
        return NativeCalls.godot_icall_1_855(MethodBind90, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind91 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetPaused, 1265174801ul);

    /// <summary>
    /// <para>If <paramref name="paused"/> is <see langword="true"/> the specified <paramref name="agent"/> will not be processed. For example, it will not calculate avoidance velocities or receive avoidance callbacks.</para>
    /// </summary>
    public static void AgentSetPaused(Rid agent, bool paused)
    {
        NativeCalls.godot_icall_2_434(MethodBind91, GodotObject.GetPtr(Singleton), agent, paused.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind92 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetPaused, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind92, GodotObject.GetPtr(Singleton), agent).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind93 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetNeighborDistance, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind93, GodotObject.GetPtr(Singleton), agent, distance);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind94 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetNeighborDistance, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind94, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind95 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetMaxNeighbors, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_426(MethodBind95, GodotObject.GetPtr(Singleton), agent, count);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind96 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetMaxNeighbors, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_835(MethodBind96, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind97 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetTimeHorizonAgents, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind97, GodotObject.GetPtr(Singleton), agent, timeHorizon);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind98 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetTimeHorizonAgents, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind98, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind99 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetTimeHorizonObstacles, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind99, GodotObject.GetPtr(Singleton), agent, timeHorizon);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind100 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetTimeHorizonObstacles, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind100, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind101 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetRadius, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind101, GodotObject.GetPtr(Singleton), agent, radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind102 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetRadius, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind102, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind103 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetHeight, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind103, GodotObject.GetPtr(Singleton), agent, height);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind104 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetHeight, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind104, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind105 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetMaxSpeed, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind105, GodotObject.GetPtr(Singleton), agent, maxSpeed);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind106 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetMaxSpeed, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind106, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind107 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetVelocityForced, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind107, GodotObject.GetPtr(Singleton), agent, &velocity);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind108 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetVelocity, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind108, GodotObject.GetPtr(Singleton), agent, &velocity);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind109 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetVelocity, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind109, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind110 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetPosition, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind110, GodotObject.GetPtr(Singleton), agent, &position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind111 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetPosition, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind111, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind112 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentIsMapChanged, 4155700596ul);

    /// <summary>
    /// <para>Returns <see langword="true"/> if the map got changed the previous frame.</para>
    /// </summary>
    public static bool AgentIsMapChanged(Rid agent)
    {
        return NativeCalls.godot_icall_1_421(MethodBind112, GodotObject.GetPtr(Singleton), agent).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind113 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetAvoidanceCallback, 3379118538ul);
    ...
    {
        NativeCalls.godot_icall_2_814(MethodBind113, GodotObject.GetPtr(Singleton), agent, callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind114 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentHasAvoidanceCallback, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind114, GodotObject.GetPtr(Singleton), agent).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind115 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetAvoidanceLayers, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_856(MethodBind115, GodotObject.GetPtr(Singleton), agent, layers);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind116 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetAvoidanceLayers, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind116, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind117 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetAvoidanceMask, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_856(MethodBind117, GodotObject.GetPtr(Singleton), agent, mask);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind118 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetAvoidanceMask, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind118, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind119 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentSetAvoidancePriority, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind119, GodotObject.GetPtr(Singleton), agent, priority);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind120 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.AgentGetAvoidancePriority, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind120, GodotObject.GetPtr(Singleton), agent);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind121 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleCreate, 529393457ul);
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind121, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind122 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetAvoidanceEnabled, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind122, GodotObject.GetPtr(Singleton), obstacle, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind123 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetAvoidanceEnabled, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind123, GodotObject.GetPtr(Singleton), obstacle).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind124 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetUse3DAvoidance, 1265174801ul);
    ...
    {
        NativeCalls.godot_icall_2_434(MethodBind124, GodotObject.GetPtr(Singleton), obstacle, enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind125 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetUse3DAvoidance, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind125, GodotObject.GetPtr(Singleton), obstacle).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind126 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetMap, 395945892ul);
    ...
    {
        NativeCalls.godot_icall_2_430(MethodBind126, GodotObject.GetPtr(Singleton), obstacle, map);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind127 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetMap, 3814569979ul);
    ...
    {
        return NativeCalls.godot_icall_1_855(MethodBind127, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind128 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetPaused, 1265174801ul);

    /// <summary>
    /// <para>If <paramref name="paused"/> is <see langword="true"/> the specified <paramref name="obstacle"/> will not be processed. For example, it will no longer affect avoidance velocities.</para>
    /// </summary>
    public static void ObstacleSetPaused(Rid obstacle, bool paused)
    {
        NativeCalls.godot_icall_2_434(MethodBind128, GodotObject.GetPtr(Singleton), obstacle, paused.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind129 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetPaused, 4155700596ul);
    ...
    {
        return NativeCalls.godot_icall_1_421(MethodBind129, GodotObject.GetPtr(Singleton), obstacle).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind130 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetRadius, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind130, GodotObject.GetPtr(Singleton), obstacle, radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind131 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetRadius, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind131, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind132 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetHeight, 1794382983ul);
    ...
    {
        NativeCalls.godot_icall_2_816(MethodBind132, GodotObject.GetPtr(Singleton), obstacle, height);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind133 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetHeight, 866169185ul);
    ...
    {
        return NativeCalls.godot_icall_1_817(MethodBind133, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind134 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetVelocity, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind134, GodotObject.GetPtr(Singleton), obstacle, &velocity);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind135 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetVelocity, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind135, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind136 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetPosition, 3227306858ul);
    ...
    {
        NativeCalls.godot_icall_2_865(MethodBind136, GodotObject.GetPtr(Singleton), obstacle, &position);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind137 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetPosition, 531438156ul);
    ...
    {
        return NativeCalls.godot_icall_1_866(MethodBind137, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind138 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetVertices, 4030257846ul);
    ...
    {
        NativeCalls.godot_icall_2_877(MethodBind138, GodotObject.GetPtr(Singleton), obstacle, vertices);
    }

    /// <summary>
    /// <para>Sets the outline vertices for the obstacle. If the vertices are winded in clockwise order agents will be pushed in by the obstacle, else they will be pushed out.</para>
    /// </summary>
    public static void ObstacleSetVertices(Rid obstacle, ReadOnlySpan<Vector3> vertices)
    {
        NativeCalls.godot_icall_2_877(MethodBind138, GodotObject.GetPtr(Singleton), obstacle, vertices);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind139 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetVertices, 808965560ul);
    ...
    {
        return NativeCalls.godot_icall_1_878(MethodBind139, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind140 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleSetAvoidanceLayers, 3411492887ul);
    ...
    {
        NativeCalls.godot_icall_2_856(MethodBind140, GodotObject.GetPtr(Singleton), obstacle, layers);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind141 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ObstacleGetAvoidanceLayers, 2198884583ul);
    ...
    {
        return NativeCalls.godot_icall_1_850(MethodBind141, GodotObject.GetPtr(Singleton), obstacle);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind142 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.ParseSourceGeometryData, 3172802542ul);
    ...
    {
        NativeCalls.godot_icall_4_836(MethodBind142, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), GodotObject.GetPtr(rootNode), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind143 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.BakeFromSourceGeometryData, 1286748856ul);
    ...
    {
        NativeCalls.godot_icall_3_837(MethodBind143, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind144 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.BakeFromSourceGeometryDataAsync, 1286748856ul);
    ...
    {
        NativeCalls.godot_icall_3_837(MethodBind144, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(navigationMesh), GodotObject.GetPtr(sourceGeometryData), callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind145 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.IsBakingNavigationMesh, 3142026141ul);
    ...
    {
        return NativeCalls.godot_icall_1_176(MethodBind145, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(navigationMesh)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind146 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SourceGeometryParserCreate, 529393457ul);
    ...
    {
        return NativeCalls.godot_icall_0_238(MethodBind146, GodotObject.GetPtr(Singleton));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind147 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SourceGeometryParserSetCallback, 3379118538ul);
    ...
    {
        NativeCalls.godot_icall_2_814(MethodBind147, GodotObject.GetPtr(Singleton), parser, callback);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind148 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SimplifyPath, 2344122170ul);
    ...
    {
        return NativeCalls.godot_icall_2_879(MethodBind148, GodotObject.GetPtr(Singleton), path, epsilon);
    }
    ...
    /// <para>Path simplification can be helpful to mitigate various path following issues that can arise with certain agent types and script behaviors. E.g. "steering" agents or avoidance in "open fields".</para>
    /// </summary>
    public static Vector3[] SimplifyPath(ReadOnlySpan<Vector3> path, float epsilon)
    {
        return NativeCalls.godot_icall_2_879(MethodBind148, GodotObject.GetPtr(Singleton), path, epsilon);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind149 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.FreeRid, 2722037293ul);
    ...
    {
        NativeCalls.godot_icall_1_286(MethodBind149, GodotObject.GetPtr(Singleton), rid);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind150 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetActive, 2586408642ul);
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind150, GodotObject.GetPtr(Singleton), active.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind151 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDebugEnabled, 2586408642ul);
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind151, GodotObject.GetPtr(Singleton), enabled.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind152 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDebugEnabled, 36873697ul);
    ...
    {
        return NativeCalls.godot_icall_0_15(MethodBind152, GodotObject.GetPtr(Singleton)).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind153 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.GetProcessInfo, 1938440894ul);

    /// <summary>
    /// <para>Returns information about the current state of the NavigationServer.</para>
    /// </summary>
    public static int GetProcessInfo(NavigationServer3D.ProcessInfo processInfo)
    {
        return NativeCalls.godot_icall_1_60(MethodBind153, GodotObject.GetPtr(Singleton), (int)processInfo);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind154 = GodotObject.ClassDB_get_method_with_compatibility(NativeName, MethodName.QueryPath, 3415008901ul);
    ...
    {
        NativeCalls.godot_icall_2_239(MethodBind154, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(parameters), GodotObject.GetPtr(result));
    }
    ...
    public class MethodName
    {
        ...
        /// <summary>
        /// Cached name for the 'map_set_use_async_iterations' method.
        /// </summary>
        public static readonly StringName MapSetUseAsyncIterations = "map_set_use_async_iterations";
        /// <summary>
        /// Cached name for the 'map_get_use_async_iterations' method.
        /// </summary>
        public static readonly StringName MapGetUseAsyncIterations = "map_get_use_async_iterations";
        /// <summary>
        ...
        /// <summary>
        /// Cached name for the 'region_get_iteration_id' method.
        /// </summary>
        public static readonly StringName RegionGetIterationId = "region_get_iteration_id";
        /// <summary>
        /// Cached name for the 'region_set_use_async_iterations' method.
        /// </summary>
        public static readonly StringName RegionSetUseAsyncIterations = "region_set_use_async_iterations";
        /// <summary>
        /// Cached name for the 'region_get_use_async_iterations' method.
        /// </summary>
        public static readonly StringName RegionGetUseAsyncIterations = "region_get_use_async_iterations";
        /// <summary>
        ...
        /// <summary>
        /// Cached name for the 'region_get_closest_point_to_segment' method.
        /// </summary>
        public static readonly StringName RegionGetClosestPointToSegment = "region_get_closest_point_to_segment";
        /// <summary>
        /// Cached name for the 'region_get_closest_point' method.
        /// </summary>
        public static readonly StringName RegionGetClosestPoint = "region_get_closest_point";
        /// <summary>
        /// Cached name for the 'region_get_closest_point_normal' method.
        /// </summary>
        public static readonly StringName RegionGetClosestPointNormal = "region_get_closest_point_normal";
        /// <summary>
        ...
        /// <summary>
        /// Cached name for the 'region_get_bounds' method.
        /// </summary>
        public static readonly StringName RegionGetBounds = "region_get_bounds";
        /// <summary>
        /// Cached name for the 'link_create' method.
        /// </summary>
        public static readonly StringName LinkCreate = "link_create";
        /// <summary>
        /// Cached name for the 'link_get_iteration_id' method.
        /// </summary>
        public static readonly StringName LinkGetIterationId = "link_get_iteration_id";
        /// <summary>
