...
#nullable disable
/// <summary>
/// <para>Object for storing the queries 2D mesh result data when calling <see cref="Godot.OpenXRSpatialEntityExtension.QuerySnapshot(Rid, Godot.Collections.Array{OpenXRSpatialComponentData}, OpenXRStructureBase)"/>.</para>
/// </summary>
public partial class OpenXRSpatialComponentMesh2DList : OpenXRSpatialComponentData
{
    private static readonly System.Type CachedType = typeof(OpenXRSpatialComponentMesh2DList);

    private static readonly StringName NativeName = "OpenXRSpatialComponentMesh2DList";

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly unsafe delegate* unmanaged<godot_bool, IntPtr> NativeCtor = ClassDB_get_constructor(NativeName);

    public OpenXRSpatialComponentMesh2DList() : this(true)
    {
        unsafe
        {
    ...
    internal OpenXRSpatialComponentMesh2DList(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    internal OpenXRSpatialComponentMesh2DList(bool memoryOwn) : base(memoryOwn) { }
    ...
    /// <summary>
    /// <para>Returns the mesh vertices for the entity at this <paramref name="index"/>.</para>
    /// </summary>
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind2 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetIndices, 3393655756ul);

    /// <summary>
    /// <para>Returns the mesh indices for the entity at this <paramref name="index"/>.</para>
    /// </summary>
    public int[] GetIndices(Rid snapshot, long index)
    {
        return NativeCalls.godot_icall_2_951(MethodBind2, GodotObject.GetPtr(this), snapshot, index);
    }
