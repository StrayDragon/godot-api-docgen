...
public partial class VisualShaderNodeMix : VisualShaderNode
{
    ...
    internal VisualShaderNodeMix(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeMix.OpTypeEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
