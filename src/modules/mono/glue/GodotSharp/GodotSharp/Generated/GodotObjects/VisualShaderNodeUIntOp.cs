...
public partial class VisualShaderNodeUIntOp : VisualShaderNode
{
    ...
    internal VisualShaderNodeUIntOp(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeUIntOp.OperatorEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
