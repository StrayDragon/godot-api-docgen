...
/// </summary>
public static partial class NavigationServer3DManager
{
    private static readonly StringName NativeName = "NavigationServer3DManager";

    private static NavigationServer3DManagerInstance singleton;

    public static NavigationServer3DManagerInstance Singleton =>
        singleton ??= (NavigationServer3DManagerInstance)InteropUtils.EngineGetSingleton("NavigationServer3DManager");
