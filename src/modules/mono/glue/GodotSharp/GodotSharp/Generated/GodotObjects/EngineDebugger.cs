...
public static partial class EngineDebugger
{
    ...
    {
        NativeCalls.godot_icall_2_159(MethodBind1, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default), GodotObject.GetPtr(profiler));
    }
    ...
    {
        NativeCalls.godot_icall_1_64(MethodBind2, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default));
    }
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind3, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind4, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_547(MethodBind5, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default), (godot_array)(data ?? new()).NativeValue);
    }
    ...
    {
        NativeCalls.godot_icall_3_548(MethodBind6, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default), enable.ToGodotBool(), (godot_array)(arguments ?? new()).NativeValue);
    }
    ...
    {
        NativeCalls.godot_icall_2_549(MethodBind7, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default), callable);
    }
    ...
    {
        NativeCalls.godot_icall_1_64(MethodBind8, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default));
    }
    ...
    {
        return NativeCalls.godot_icall_1_105(MethodBind9, GodotObject.GetPtr(Singleton), (godot_string_name)(name?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_469(MethodBind11, GodotObject.GetPtr(Singleton), message, (godot_array)(data ?? new()).NativeValue);
    }
    ...
    {
        NativeCalls.godot_icall_2_550(MethodBind12, GodotObject.GetPtr(Singleton), canContinue.ToGodotBool(), isErrorBreakpoint.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_3_551(MethodBind13, GodotObject.GetPtr(Singleton), GodotObject.GetPtr(language), canContinue.ToGodotBool(), isErrorBreakpoint.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind14, GodotObject.GetPtr(Singleton), lines);
    }
    ...
    {
        return NativeCalls.godot_icall_0_39(MethodBind15, GodotObject.GetPtr(Singleton));
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind16, GodotObject.GetPtr(Singleton), depth);
    }
    ...
    {
        return NativeCalls.godot_icall_0_39(MethodBind17, GodotObject.GetPtr(Singleton));
    }
    ...
    {
        return NativeCalls.godot_icall_2_552(MethodBind18, GodotObject.GetPtr(Singleton), line, (godot_string_name)(source?.NativeValue ?? default)).ToBool();
    }
    ...
    {
        return NativeCalls.godot_icall_0_15(MethodBind19, GodotObject.GetPtr(Singleton)).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_2_178(MethodBind20, GodotObject.GetPtr(Singleton), line, (godot_string_name)(source?.NativeValue ?? default));
    }
    ...
    {
        NativeCalls.godot_icall_2_178(MethodBind21, GodotObject.GetPtr(Singleton), line, (godot_string_name)(source?.NativeValue ?? default));
    }
