...
#nullable disable
/// <summary>
/// <para><see cref="Godot.OpenXRExtensionWrapperExtension"/> allows implementing OpenXR extensions with GDExtension. The extension should be registered with <see cref="Godot.OpenXRExtensionWrapper.RegisterExtensionWrapper()"/>.</para>
/// </summary>
[Obsolete("Use 'OpenXRExtensionWrapper' instead.")]
public partial class OpenXRExtensionWrapperExtension : OpenXRExtensionWrapper
{
    ...
    internal OpenXRExtensionWrapperExtension(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
