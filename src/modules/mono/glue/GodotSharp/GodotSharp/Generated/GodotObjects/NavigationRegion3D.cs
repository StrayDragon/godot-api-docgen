...
public partial class NavigationRegion3D : Node3D
{
    ...
    internal NavigationRegion3D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind1, GodotObject.GetPtr(this), GodotObject.GetPtr(navigationMesh));
    }
    ...
    {
        return (NavigationMesh)NativeCalls.godot_icall_0_63(MethodBind2, GodotObject.GetPtr(this));
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind20 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetBounds, 1068685055ul);

    /// <summary>
    /// <para>Returns the axis-aligned bounding box for the region's transformed navigation mesh.</para>
    /// </summary>
    ...
    protected void EmitSignalNavigationMeshChanged()
    {
        EmitSignal(SignalName.NavigationMeshChanged);
    }
