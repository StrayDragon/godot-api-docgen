...
public partial class PhysicsTestMotionParameters2D : RefCounted
{
    ...
    internal PhysicsTestMotionParameters2D(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_218(MethodBind1, GodotObject.GetPtr(this), &from);
    }
    ...
    {
        NativeCalls.godot_icall_1_36(MethodBind3, GodotObject.GetPtr(this), &motion);
    }
    ...
    {
        NativeCalls.godot_icall_1_138(MethodBind9, GodotObject.GetPtr(this), (godot_array)(excludeList ?? new()).NativeValue);
    }
    ...
    {
        return new Godot.Collections.Array<int>(NativeCalls.godot_icall_0_120(MethodBind10, GodotObject.GetPtr(this)));
    }
