...
public partial class VisualShaderNodeIntFunc : VisualShaderNode
{
    ...
    internal VisualShaderNodeIntFunc(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        return (VisualShaderNodeIntFunc.FunctionEnum)NativeCalls.godot_icall_0_39(MethodBind1, GodotObject.GetPtr(this));
    }
