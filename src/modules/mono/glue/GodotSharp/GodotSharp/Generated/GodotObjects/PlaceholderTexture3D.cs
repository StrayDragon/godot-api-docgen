...
public partial class PlaceholderTexture3D : Texture3D
{
    ...
    internal PlaceholderTexture3D(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_1011(MethodBind0, GodotObject.GetPtr(this), &size);
    }
    ...
    {
        return NativeCalls.godot_icall_0_1012(MethodBind1, GodotObject.GetPtr(this));
    }
