...
public partial class Sprite2D : Node2D
{
    ...
    /// <para><b>Note:</b> When you increase <see cref="Godot.Sprite2D.Offset"/>.y in Sprite2D, the sprite moves downward on screen (i.e., +Y is down).</para>
    /// </summary>
    ...
    /// <para><b>Note:</b> When using a custom <see cref="Godot.Shader"/> on a <see cref="Godot.Sprite2D"/>, the <c>UV</c> shader built-in will refer to the entire texture space. Use the <c>REGION_RECT</c> built-in to get the currently visible region defined in <see cref="Godot.Sprite2D.RegionRect"/> instead. See <a href="$DOCS_URL/tutorials/shaders/shader_reference/canvas_item_shader.html">CanvasItem shaders</a> for details.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>If <see langword="true"/>, the area outside of the <see cref="Godot.Sprite2D.RegionRect"/> is clipped to avoid bleeding of the surrounding texture pixels. <see cref="Godot.Sprite2D.RegionEnabled"/> must be <see langword="true"/>.</para>
    /// </summary>
    ...
    internal Sprite2D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind2, GodotObject.GetPtr(this), centered.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind6, GodotObject.GetPtr(this), flipH.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind8, GodotObject.GetPtr(this), flipV.ToGodotBool());
    }
    ...
    /// <summary>
    /// <para>Returns <see langword="true"/> if the pixel at the given position is opaque, <see langword="false"/> otherwise. Also returns <see langword="false"/> if the given position is out of bounds or this sprite's <see cref="Godot.Sprite2D.Texture"/> is <see langword="null"/>. <paramref name="pos"/> is in local coordinates.</para>
    /// </summary>
    public unsafe bool IsPixelOpaque(Vector2 pos)
    {
        return NativeCalls.godot_icall_1_199(MethodBind12, GodotObject.GetPtr(this), &pos).ToBool();
    }
    ...
    {
        NativeCalls.godot_icall_1_188(MethodBind13, GodotObject.GetPtr(this), &rect);
    }
    ...
    {
        return NativeCalls.godot_icall_0_189(MethodBind14, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind17, GodotObject.GetPtr(this), frame);
    }
    ...
    {
        NativeCalls.godot_icall_1_34(MethodBind19, GodotObject.GetPtr(this), &coords);
    }
    ...
    {
        return NativeCalls.godot_icall_0_35(MethodBind20, GodotObject.GetPtr(this));
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind21, GodotObject.GetPtr(this), vframes);
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind23, GodotObject.GetPtr(this), hframes);
    }
    ...
    /// <summary>
    /// <para>Returns a <see cref="Godot.Rect2"/> representing the Sprite2D's boundary in local coordinates.</para>
    /// <para><b>Example:</b> Detect if the Sprite2D was clicked:</para>
    /// <para><code>
    ...
    {
        return NativeCalls.godot_icall_0_189(MethodBind25, GodotObject.GetPtr(this));
    }
    ...
    protected void EmitSignalTextureChanged()
    {
