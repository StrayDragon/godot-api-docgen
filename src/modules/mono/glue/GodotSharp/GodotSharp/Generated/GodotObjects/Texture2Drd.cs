...
/// <para><b>Note:</b> <see cref="Godot.Texture2Drd"/> is intended for low-level usage with <see cref="Godot.RenderingDevice"/>. For most use cases, use <see cref="Godot.Texture2D"/> instead.</para>
/// </summary>
...
public partial class Texture2Drd : Texture2D
{
    ...
    internal Texture2Drd(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
