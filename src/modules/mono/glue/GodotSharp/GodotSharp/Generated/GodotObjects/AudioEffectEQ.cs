...
public partial class AudioEffectEQ : AudioEffect
{
    ...
    internal AudioEffectEQ(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_2_69(MethodBind0, GodotObject.GetPtr(this), bandIdx, volumeDb);
    }
    ...
    {
        return NativeCalls.godot_icall_1_72(MethodBind1, GodotObject.GetPtr(this), bandIdx);
    }
