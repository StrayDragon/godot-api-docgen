...
public partial class CpuParticles2D : Node2D
{
    ...
    public enum EmissionShapeEnum : long
    {
        ...
        DirectedPoints = 5,
        /// <summary>
        /// <para>Particles will be emitted in the area of a ring parameterized by its outer and inner radius.</para>
        /// </summary>
        Ring = 6,
        /// <summary>
    ...
    /// <summary>
    /// <para>If <see langword="true"/>, particles will use the same seed for every simulation using the seed defined in <see cref="Godot.CpuParticles2D.Seed"/>. This is useful for situations where the visual outcome should be consistent across replays, for example when using Movie Maker mode.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Sets the random seed used by the particle system. Only effective if <see cref="Godot.CpuParticles2D.UseFixedSeed"/> is <see langword="true"/>.</para>
    /// </summary>
    public uint Seed
    {
        get
    ...
    /// <summary>
    /// <para>The ring's inner radius if <see cref="Godot.CpuParticles2D.EmissionShape"/> is set to <see cref="Godot.CpuParticles2D.EmissionShapeEnum.Ring"/>.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>The ring's outer radius if <see cref="Godot.CpuParticles2D.EmissionShape"/> is set to <see cref="Godot.CpuParticles2D.EmissionShapeEnum.Ring"/>.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Each particle's angular velocity will vary along this <see cref="Godot.Curve"/>. Should be a unit <see cref="Godot.Curve"/>.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Each particle's horizontal scale will vary along this <see cref="Godot.Curve"/>. Should be a unit <see cref="Godot.Curve"/>.</para>
    ...
    /// <summary>
    /// <para>Each particle's vertical scale will vary along this <see cref="Godot.Curve"/>. Should be a unit <see cref="Godot.Curve"/>.</para>
    /// <para><see cref="Godot.CpuParticles2D.SplitScale"/> must be enabled.</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Each particle's color will vary along this <see cref="Godot.Gradient"/> over its lifetime (multiplied with <see cref="Godot.CpuParticles2D.Color"/>).</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>Each particle's initial color will vary along this <see cref="Godot.Gradient"/> (multiplied with <see cref="Godot.CpuParticles2D.Color"/>).</para>
    /// </summary>
    ...
    internal CpuParticles2D(IntPtr ptr) : this(false)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    {
        NativeCalls.godot_icall_1_127(MethodBind7, GodotObject.GetPtr(this), random);
    }
    ...
    {
        NativeCalls.godot_icall_1_38(MethodBind9, GodotObject.GetPtr(this), fps);
    }
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind10, GodotObject.GetPtr(this), enable.ToGodotBool());
    }
    ...
    {
        NativeCalls.godot_icall_1_127(MethodBind11, GodotObject.GetPtr(this), scale);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind12 = ClassDB_get_method_with_compatibility(NativeName, MethodName.RequestParticlesProcess, 373806689ul);

    /// <summary>
    /// <para>Requests the particles to process for extra process time during a single frame.</para>
    /// <para>Useful for particle playback, if used in combination with <see cref="Godot.CpuParticles2D.UseFixedSeed"/> or by calling <see cref="Godot.CpuParticles2D.Restart(bool)"/> with parameter <c>keep_seed</c> set to <see langword="true"/>.</para>
    /// </summary>
    public void RequestParticlesProcess(float processTime)
    {
        NativeCalls.godot_icall_1_67(MethodBind12, GodotObject.GetPtr(this), processTime);
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind20 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetLifetimeRandomness, 1740695150ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public double GetLifetimeRandomness()
    {
        return NativeCalls.godot_icall_0_144(MethodBind20, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind21 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetUseLocalCoordinates, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind22 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetFixedFps, 3905245786ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind23 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetFractionalDelta, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind24 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSpeedScale, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind25 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetUseFixedSeed, 2586408642ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetUseFixedSeed(bool useFixedSeed)
    {
        NativeCalls.godot_icall_1_14(MethodBind25, GodotObject.GetPtr(this), useFixedSeed.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind26 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetUseFixedSeed, 36873697ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind27 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetSeed, 1286410249ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetSeed(uint seed)
    {
        NativeCalls.godot_icall_1_208(MethodBind27, GodotObject.GetPtr(this), seed);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind28 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSeed, 3905245786ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public uint GetSeed()
    {
        return NativeCalls.godot_icall_0_209(MethodBind28, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind29 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDrawOrder, 4183193490ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetDrawOrder(CpuParticles2D.DrawOrderEnum order)
    {
        NativeCalls.godot_icall_1_38(MethodBind29, GodotObject.GetPtr(this), (int)order);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind30 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDrawOrder, 1668655735ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public CpuParticles2D.DrawOrderEnum GetDrawOrder()
    {
        return (CpuParticles2D.DrawOrderEnum)NativeCalls.godot_icall_0_39(MethodBind30, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind31 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetTexture, 4051416890ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetTexture(Texture2D texture)
    {
        NativeCalls.godot_icall_1_56(MethodBind31, GodotObject.GetPtr(this), GodotObject.GetPtr(texture));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind32 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetTexture, 3635182373ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Texture2D GetTexture()
    {
        return (Texture2D)NativeCalls.godot_icall_0_63(MethodBind32, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind33 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Restart, 107499316ul);
    ...
    {
        NativeCalls.godot_icall_1_14(MethodBind33, GodotObject.GetPtr(this), keepSeed.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind34 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetDirection, 743155724ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetDirection(Vector2 direction)
    {
        NativeCalls.godot_icall_1_36(MethodBind34, GodotObject.GetPtr(this), &direction);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind35 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetDirection, 3341600327ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind36 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetSpread, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetSpread(float spread)
    {
        NativeCalls.godot_icall_1_67(MethodBind36, GodotObject.GetPtr(this), spread);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind37 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSpread, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind38 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetParamMin, 3320615296ul);
    ...
    {
        NativeCalls.godot_icall_2_69(MethodBind38, GodotObject.GetPtr(this), (int)param, value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind39 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetParamMin, 2038050600ul);
    ...
    {
        return NativeCalls.godot_icall_1_72(MethodBind39, GodotObject.GetPtr(this), (int)param);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind40 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetParamMax, 3320615296ul);
    ...
    {
        NativeCalls.godot_icall_2_69(MethodBind40, GodotObject.GetPtr(this), (int)param, value);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind41 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetParamMax, 2038050600ul);
    ...
    {
        return NativeCalls.godot_icall_1_72(MethodBind41, GodotObject.GetPtr(this), (int)param);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind42 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetParamCurve, 2959350143ul);

    /// <summary>
    /// <para>Sets the <see cref="Godot.Curve"/> of the parameter specified by <see cref="Godot.CpuParticles2D.Parameter"/>. Should be a unit <see cref="Godot.Curve"/>.</para>
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetParamCurve(CpuParticles2D.Parameter param, Curve curve)
    {
        NativeCalls.godot_icall_2_70(MethodBind42, GodotObject.GetPtr(this), (int)param, GodotObject.GetPtr(curve));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind43 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetParamCurve, 2603158474ul);
    ...
    {
        return (Curve)NativeCalls.godot_icall_1_71(MethodBind43, GodotObject.GetPtr(this), (int)param);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind44 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetColor, 2920490490ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetColor(Color color)
    {
        NativeCalls.godot_icall_1_213(MethodBind44, GodotObject.GetPtr(this), &color);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind45 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetColor, 3444240500ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind46 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetColorRamp, 2756054477ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetColorRamp(Gradient ramp)
    {
        NativeCalls.godot_icall_1_56(MethodBind46, GodotObject.GetPtr(this), GodotObject.GetPtr(ramp));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind47 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetColorRamp, 132272999ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Gradient GetColorRamp()
    {
        return (Gradient)NativeCalls.godot_icall_0_63(MethodBind47, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind48 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetColorInitialRamp, 2756054477ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetColorInitialRamp(Gradient ramp)
    {
        NativeCalls.godot_icall_1_56(MethodBind48, GodotObject.GetPtr(this), GodotObject.GetPtr(ramp));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind49 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetColorInitialRamp, 132272999ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Gradient GetColorInitialRamp()
    {
        return (Gradient)NativeCalls.godot_icall_0_63(MethodBind49, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind50 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetParticleFlag, 4178137949ul);
    ...
    {
        NativeCalls.godot_icall_2_61(MethodBind50, GodotObject.GetPtr(this), (int)particleFlag, enable.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind51 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetParticleFlag, 2829976507ul);
    ...
    {
        return NativeCalls.godot_icall_1_62(MethodBind51, GodotObject.GetPtr(this), (int)particleFlag).ToBool();
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind52 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionShape, 393763892ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionShape(CpuParticles2D.EmissionShapeEnum shape)
    {
        NativeCalls.godot_icall_1_38(MethodBind52, GodotObject.GetPtr(this), (int)shape);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind53 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionShape, 1740246024ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public CpuParticles2D.EmissionShapeEnum GetEmissionShape()
    {
        return (CpuParticles2D.EmissionShapeEnum)NativeCalls.godot_icall_0_39(MethodBind53, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind54 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionSphereRadius, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionSphereRadius(float radius)
    {
        NativeCalls.godot_icall_1_67(MethodBind54, GodotObject.GetPtr(this), radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind55 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionSphereRadius, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind56 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionRectExtents, 743155724ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetEmissionRectExtents(Vector2 extents)
    {
        NativeCalls.godot_icall_1_36(MethodBind56, GodotObject.GetPtr(this), &extents);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind57 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionRectExtents, 3341600327ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Vector2 GetEmissionRectExtents()
    {
        return NativeCalls.godot_icall_0_37(MethodBind57, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind58 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionPoints, 1509147220ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionPoints(Vector2[] array)
    {
        NativeCalls.godot_icall_1_224(MethodBind58, GodotObject.GetPtr(this), array);
    }

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionPoints(ReadOnlySpan<Vector2> array)
    {
        NativeCalls.godot_icall_1_224(MethodBind58, GodotObject.GetPtr(this), array);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind59 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionPoints, 2961356807ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Vector2[] GetEmissionPoints()
    {
        return NativeCalls.godot_icall_0_225(MethodBind59, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind60 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionNormals, 1509147220ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionNormals(Vector2[] array)
    {
        NativeCalls.godot_icall_1_224(MethodBind60, GodotObject.GetPtr(this), array);
    }

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionNormals(ReadOnlySpan<Vector2> array)
    {
        NativeCalls.godot_icall_1_224(MethodBind60, GodotObject.GetPtr(this), array);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind61 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionNormals, 2961356807ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Vector2[] GetEmissionNormals()
    {
        return NativeCalls.godot_icall_0_225(MethodBind61, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind62 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionColors, 3546319833ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionColors(Color[] array)
    {
        NativeCalls.godot_icall_1_226(MethodBind62, GodotObject.GetPtr(this), array);
    }
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind63 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionColors, 1392750486ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Color[] GetEmissionColors()
    {
        return NativeCalls.godot_icall_0_227(MethodBind63, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind64 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionRingInnerRadius, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionRingInnerRadius(float innerRadius)
    {
        NativeCalls.godot_icall_1_67(MethodBind64, GodotObject.GetPtr(this), innerRadius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind65 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionRingInnerRadius, 1740695150ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind66 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetEmissionRingRadius, 373806689ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetEmissionRingRadius(float radius)
    {
        NativeCalls.godot_icall_1_67(MethodBind66, GodotObject.GetPtr(this), radius);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind67 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetEmissionRingRadius, 1740695150ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public float GetEmissionRingRadius()
    {
        return NativeCalls.godot_icall_0_68(MethodBind67, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind68 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetGravity, 3341600327ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Vector2 GetGravity()
    {
        return NativeCalls.godot_icall_0_37(MethodBind68, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind69 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetGravity, 743155724ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public unsafe void SetGravity(Vector2 accelVec)
    {
        NativeCalls.godot_icall_1_36(MethodBind69, GodotObject.GetPtr(this), &accelVec);
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind70 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetSplitScale, 2240911060ul);
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind71 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetSplitScale, 2586408642ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetSplitScale(bool splitScale)
    {
        NativeCalls.godot_icall_1_14(MethodBind71, GodotObject.GetPtr(this), splitScale.ToGodotBool());
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind72 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetScaleCurveX, 2460114913ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Curve GetScaleCurveX()
    {
        return (Curve)NativeCalls.godot_icall_0_63(MethodBind72, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind73 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetScaleCurveX, 270443179ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetScaleCurveX(Curve scaleCurve)
    {
        NativeCalls.godot_icall_1_56(MethodBind73, GodotObject.GetPtr(this), GodotObject.GetPtr(scaleCurve));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind74 = ClassDB_get_method_with_compatibility(NativeName, MethodName.GetScaleCurveY, 2460114913ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public Curve GetScaleCurveY()
    {
        return (Curve)NativeCalls.godot_icall_0_63(MethodBind74, GodotObject.GetPtr(this));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind75 = ClassDB_get_method_with_compatibility(NativeName, MethodName.SetScaleCurveY, 270443179ul);

    [EditorBrowsable(EditorBrowsableState.Never)]
    public void SetScaleCurveY(Curve scaleCurve)
    {
        NativeCalls.godot_icall_1_56(MethodBind75, GodotObject.GetPtr(this), GodotObject.GetPtr(scaleCurve));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind76 = ClassDB_get_method_with_compatibility(NativeName, MethodName.ConvertFromParticles, 1078189570ul);
    ...
    {
        NativeCalls.godot_icall_1_56(MethodBind76, GodotObject.GetPtr(this), GodotObject.GetPtr(particles));
    }

    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind77 = ClassDB_get_method_with_compatibility(NativeName, MethodName.Restart, 3218959716ul);
