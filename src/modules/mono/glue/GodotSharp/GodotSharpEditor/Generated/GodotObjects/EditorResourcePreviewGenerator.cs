...
public partial class EditorResourcePreviewGenerator : RefCounted
{
    ...
    internal EditorResourcePreviewGenerator(IntPtr ptr) : this(true)
    {
        NativePtr = ptr;
        unsafe
        {
    ...
    [DebuggerBrowsable(DebuggerBrowsableState.Never)]
    private static readonly IntPtr MethodBind0 = ClassDB_get_method_with_compatibility(NativeName, MethodName.RequestDrawAndWait, 145472570ul);

    /// <summary>
    /// <para>Call from within <see cref="Godot.EditorResourcePreviewGenerator._Generate(Resource, Vector2I, Godot.Collections.Dictionary)"/> to request the rendering server draw to the <paramref name="viewport"/>.</para>
    /// </summary>
    public void RequestDrawAndWait(Rid viewport)
    {
        NativeCalls.godot_icall_1_286(MethodBind0, GodotObject.GetPtr(this), viewport);
    }
...
#pragma warning restore CS0618
    ...
    public new class MethodName : RefCounted.MethodName
    {
        ...
        /// <summary>
        /// Cached name for the 'request_draw_and_wait' method.
        /// </summary>
        public static readonly StringName RequestDrawAndWait = "request_draw_and_wait";
    }
